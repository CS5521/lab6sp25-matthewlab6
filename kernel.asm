...
80100087:	c7 44 24 04 5f 82 10 	movl   $0x8010825f,0x4(%esp)
8010008e:	80 
...
801001a7:	c7 04 24 66 82 10 80 	movl   $0x80108266,(%esp)
...
80100202:	75 0c                	jne    80100210 <bwrite+0x24>
    panic("bwrite");
80100204:	c7 04 24 77 82 10 80 	movl   $0x80108277,(%esp)
...
80100242:	75 0c                	jne    80100250 <brelse+0x24>
    panic("brelse");
80100244:	c7 04 24 7e 82 10 80 	movl   $0x8010827e,(%esp)
...
801003ed:	75 0c                	jne    801003fb <cprintf+0x33>
    panic("null fmt");
801003ef:	c7 04 24 85 82 10 80 	movl   $0x80108285,(%esp)
...
801004d6:	75 09                	jne    801004e1 <cprintf+0x119>
        s = "(null)";
801004d8:	c7 45 ec 8e 82 10 80 	movl   $0x8010828e,-0x14(%ebp)
      for(; *s; s++)
...
80100580:	c7 04 24 95 82 10 80 	movl   $0x80108295,(%esp)
...
80100592:	e8 31 fe ff ff       	call   801003c8 <cprintf>
  cprintf("\n");
80100597:	c7 04 24 a9 82 10 80 	movl   $0x801082a9,(%esp)
...
801005c9:	c7 04 24 ab 82 10 80 	movl   $0x801082ab,(%esp)
...
801006ba:	c7 04 24 af 82 10 80 	movl   $0x801082af,(%esp)
...
80100ad6:	c7 44 24 04 c2 82 10 	movl   $0x801082c2,0x4(%esp)
80100add:	80 
...
80100b48:	e8 be 29 00 00       	call   8010350b <end_op>
    cprintf("exec: fail\n");
80100b4d:	c7 04 24 ca 82 10 80 	movl   $0x801082ca,(%esp)
...
80100bb1:	e9 85 03 00 00       	jmp    80100f3b <exec+0x41d>
  ...
  if((pgdir = setupkvm()) == 0)
80100bb6:	e8 e7 6d 00 00       	call   801079a2 <setupkvm>
...
80100c74:	e8 ff 70 00 00       	call   80107d78 <allocuvm>
...
80100cc6:	e8 ca 6f 00 00       	call   80107c95 <loaduvm>
...
80100d34:	e8 3f 70 00 00       	call   80107d78 <allocuvm>
...
80100d59:	e8 8d 72 00 00       	call   80107feb <clearpteu>
  sp = sz;
...
80100de8:	e8 c1 73 00 00       	call   801081ae <copyout>
...
80100e8f:	e8 1a 73 00 00       	call   801081ae <copyout>
...
80100f24:	e8 53 6b 00 00       	call   80107a7c <switchuvm>
  freevm(oldpgdir);
80100f29:	8b 45 cc             	mov    -0x34(%ebp),%eax
80100f2c:	89 04 24             	mov    %eax,(%esp)
80100f2f:	e8 20 70 00 00       	call   80107f54 <freevm>
  return 0;
...
80100f47:	e8 08 70 00 00       	call   80107f54 <freevm>
  if(ip){
...
80100f6f:	c7 44 24 04 d6 82 10 	movl   $0x801082d6,0x4(%esp)
80100f76:	80 
...
80100fff:	7f 0c                	jg     8010100d <filedup+0x28>
    panic("filedup");
80101001:	c7 04 24 dd 82 10 80 	movl   $0x801082dd,(%esp)
...
80101047:	7f 0c                	jg     80101055 <fileclose+0x28>
    panic("fileclose");
80101049:	c7 04 24 e5 82 10 80 	movl   $0x801082e5,(%esp)
...
801011fe:	eb 0c                	jmp    8010120c <fileread+0xba>
  ...
  panic("fileread");
80101200:	c7 04 24 ef 82 10 80 	movl   $0x801082ef,(%esp)
...
8010130c:	c7 04 24 f8 82 10 80 	movl   $0x801082f8,(%esp)
...
8010133c:	eb 0c                	jmp    8010134a <filewrite+0x13c>
  ...
  panic("filewrite");
8010133e:	c7 04 24 08 83 10 80 	movl   $0x80108308,(%esp)
...
80101517:	c7 04 24 14 83 10 80 	movl   $0x80108314,(%esp)
...
801015a6:	c7 04 24 2a 83 10 80 	movl   $0x8010832a,(%esp)
...
80101600:	c7 44 24 04 3d 83 10 	movl   $0x8010833d,0x4(%esp)
80101607:	80 
...
80101635:	c7 44 24 04 44 83 10 	movl   $0x80108344,0x4(%esp)
8010163c:	80 
...
801016af:	c7 04 24 4c 83 10 80 	movl   $0x8010834c,(%esp)
...
8010178a:	c7 04 24 9f 83 10 80 	movl   $0x8010839f,(%esp)
...
801018e3:	c7 04 24 b1 83 10 80 	movl   $0x801083b1,(%esp)
...
80101971:	7f 0c                	jg     8010197f <ilock+0x22>
    panic("ilock");
80101973:	c7 04 24 c1 83 10 80 	movl   $0x801083c1,(%esp)
...
80101a5a:	75 0c                	jne    80101a68 <ilock+0x10b>
      panic("ilock: no type");
80101a5c:	c7 04 24 c7 83 10 80 	movl   $0x801083c7,(%esp)
...
80101a90:	7f 0c                	jg     80101a9e <iunlock+0x34>
    panic("iunlock");
80101a92:	c7 04 24 d6 83 10 80 	movl   $0x801083d6,(%esp)
...
80101c7e:	c7 04 24 de 83 10 80 	movl   $0x801083de,(%esp)
...
80102122:	c7 04 24 f1 83 10 80 	movl   $0x801083f1,(%esp)
...
80102160:	c7 04 24 03 84 10 80 	movl   $0x80108403,(%esp)
...
80102243:	74 0c                	je     80102251 <dirlink+0x79>
      panic("dirlink read");
80102245:	c7 04 24 12 84 10 80 	movl   $0x80108412,(%esp)
...
801022ba:	74 0c                	je     801022c8 <dirlink+0xf0>
    panic("dirlink");
801022bc:	c7 04 24 1f 84 10 80 	movl   $0x8010841f,(%esp)
...
801025aa:	c7 44 24 04 27 84 10 	movl   $0x80108427,0x4(%esp)
801025b1:	80 
...
80102648:	75 0c                	jne    80102656 <idestart+0x18>
    panic("idestart");
8010264a:	c7 04 24 2b 84 10 80 	movl   $0x8010842b,(%esp)
...
80102663:	c7 04 24 34 84 10 80 	movl   $0x80108434,(%esp)
...
801026b5:	c7 04 24 2b 84 10 80 	movl   $0x8010842b,(%esp)
...
801028a3:	c7 04 24 46 84 10 80 	movl   $0x80108446,(%esp)
...
801028bc:	c7 04 24 5c 84 10 80 	movl   $0x8010845c,(%esp)
...
801028db:	c7 04 24 71 84 10 80 	movl   $0x80108471,(%esp)
...
801029e2:	c7 04 24 90 84 10 80 	movl   $0x80108490,(%esp)
...
80102a84:	c7 44 24 04 c2 84 10 	movl   $0x801084c2,0x4(%esp)
80102a8b:	80 
...
80102b3b:	76 0c                	jbe    80102b49 <kfree+0x36>
    panic("kfree");
80102b3d:	c7 04 24 c7 84 10 80 	movl   $0x801084c7,(%esp)
...
80103289:	c7 44 24 04 cd 84 10 	movl   $0x801084cd,0x4(%esp)
80103290:	80 
...
8010353a:	c7 04 24 d1 84 10 80 	movl   $0x801084d1,(%esp)
...
801036b4:	c7 04 24 e0 84 10 80 	movl   $0x801084e0,(%esp)
...
801036c9:	c7 04 24 f6 84 10 80 	movl   $0x801084f6,(%esp)
...
801037b4:	e8 e8 30 00 00       	call   801068a1 <uartinit>
  pinit();         // process table
801037b9:	e8 f0 08 00 00       	call   801040ae <pinit>
  tvinit();        // trap vectors
801037be:	e8 a7 2c 00 00       	call   8010646a <tvinit>
  binit();         // buffer cache
...
801037f8:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
801037fb:	e8 62 42 00 00       	call   80107a62 <switchkvm>
  seginit();
80103800:	e8 12 3d 00 00       	call   80107517 <seginit>
  lapicinit();
...
8010382a:	c7 04 24 11 85 10 80 	movl   $0x80108511,(%esp)
80103831:	e8 92 cb ff ff       	call   801003c8 <cprintf>
  idtinit();       // load idt register
80103836:	e8 a3 2d 00 00       	call   801065de <idtinit>
...
801039bb:	00 
801039bc:	c7 44 24 04 28 85 10 	movl   $0x80108528,0x4(%esp)
801039c3:	80 
...
80103af9:	00 
80103afa:	c7 44 24 04 2d 85 10 	movl   $0x8010852d,0x4(%esp)
80103b01:	80 
...
80103b80:	c7 04 24 32 85 10 80 	movl   $0x80108532,(%esp)
...
80103bc9:	8b 04 85 6c 85 10 80 	mov    -0x7fef7a94(,%eax,4),%eax
...
80103c48:	c7 04 24 4c 85 10 80 	movl   $0x8010854c,(%esp)
...
80103d7d:	c7 44 24 04 80 85 10 	movl   $0x80108580,0x4(%esp)
80103d84:	80 
...
801040b4:	c7 44 24 04 88 85 10 	movl   $0x80108588,0x4(%esp)
801040bb:	80 
...
801040ff:	c7 04 24 90 85 10 80 	movl   $0x80108590,(%esp)
...
80104153:	c7 04 24 b6 85 10 80 	movl   $0x801085b6,(%esp)
...
80104241:	ba 25 64 10 80       	mov    $0x80106425,%edx
...
8010429f:	e8 fe 36 00 00       	call   801079a2 <setupkvm>
...
801042b4:	c7 04 24 c6 85 10 80 	movl   $0x801085c6,(%esp)
...
801042da:	e8 2e 39 00 00       	call   80107c0d <inituvm>
  p->sz = PGSIZE;
...
8010437a:	00 
8010437b:	c7 44 24 04 df 85 10 	movl   $0x801085df,0x4(%esp)
80104382:	80 
80104383:	89 04 24             	mov    %eax,(%esp)
80104386:	e8 9f 0e 00 00       	call   8010522a <safestrcpy>
  p->cwd = namei("/");
8010438b:	c7 04 24 e8 85 10 80 	movl   $0x801085e8,(%esp)
...
801043f9:	e8 7a 39 00 00       	call   80107d78 <allocuvm>
...
80104430:	e8 59 3a 00 00       	call   80107e8e <deallocuvm>
...
80104453:	e8 24 36 00 00       	call   80107a7c <switchuvm>
  return 0;
...
8010449a:	e8 92 3b 00 00       	call   80108031 <copyuvm>
...
801045dc:	75 0c                	jne    801045ea <exit+0x24>
    panic("init exiting");
801045de:	c7 04 24 ea 85 10 80 	movl   $0x801085ea,(%esp)
...
801046bf:	e8 c3 01 00 00       	call   80104887 <sched>
  panic("zombie exit");
801046c4:	c7 04 24 f7 85 10 80 	movl   $0x801085f7,(%esp)
...
80104749:	e8 06 38 00 00       	call   80107f54 <freevm>
        p->pid = 0;
...
80104830:	e8 47 32 00 00       	call   80107a7c <switchuvm>
      p->state = RUNNING;
...
80104852:	e8 44 0a 00 00       	call   8010529b <swtch>
      switchkvm();
80104857:	e8 06 32 00 00       	call   80107a62 <switchkvm>
...
801048a5:	c7 04 24 03 86 10 80 	movl   $0x80108603,(%esp)
...
801048bf:	74 0c                	je     801048cd <sched+0x46>
    panic("sched locks");
801048c1:	c7 04 24 15 86 10 80 	movl   $0x80108615,(%esp)
...
801048d6:	75 0c                	jne    801048e4 <sched+0x5d>
    panic("sched running");
801048d8:	c7 04 24 21 86 10 80 	movl   $0x80108621,(%esp)
...
801048f2:	c7 04 24 2f 86 10 80 	movl   $0x8010862f,(%esp)
...
801049b8:	75 0c                	jne    801049c6 <sleep+0x20>
    panic("sleep");
801049ba:	c7 04 24 43 86 10 80 	movl   $0x80108643,(%esp)
...
801049cc:	c7 04 24 49 86 10 80 	movl   $0x80108649,(%esp)
...
80104b6a:	eb 07                	jmp    80104b73 <procdump+0x56>
      ...
      state = "???";
80104b6c:	c7 45 ec 5a 86 10 80 	movl   $0x8010865a,-0x14(%ebp)
...
80104b8e:	c7 04 24 5e 86 10 80 	movl   $0x8010865e,(%esp)
...
80104bd4:	c7 04 24 67 86 10 80 	movl   $0x80108667,(%esp)
...
80104bf3:	75 d4                	jne    80104bc9 <procdump+0xac>
    ...
    cprintf("\n");
80104bf5:	c7 04 24 6b 86 10 80 	movl   $0x8010866b,(%esp)
...
80104c20:	c7 44 24 04 97 86 10 	movl   $0x80108697,0x4(%esp)
80104c27:	80 
...
80104db1:	74 0c                	je     80104dbf <acquire+0x27>
    panic("acquire");
80104db3:	c7 04 24 a2 86 10 80 	movl   $0x801086a2,(%esp)
...
80104e13:	75 0c                	jne    80104e21 <release+0x21>
    panic("release");
80104e15:	c7 04 24 aa 86 10 80 	movl   $0x801086aa,(%esp)
...
80104f65:	c7 04 24 b2 86 10 80 	movl   $0x801086b2,(%esp)
...
80104f8d:	79 0c                	jns    80104f9b <popcli+0x4a>
    panic("popcli");
80104f8f:	c7 04 24 c9 86 10 80 	movl   $0x801086c9,(%esp)
...
8010548a:	c7 04 24 d0 86 10 80 	movl   $0x801086d0,(%esp)
...
80105920:	c7 04 24 ec 86 10 80 	movl   $0x801086ec,(%esp)
...
801059ba:	c7 44 24 04 fe 86 10 	movl   $0x801086fe,0x4(%esp)
801059c1:	80 
...
801059d5:	c7 44 24 04 00 87 10 	movl   $0x80108700,0x4(%esp)
801059dc:	80 
...
80105a2e:	c7 04 24 03 87 10 80 	movl   $0x80108703,(%esp)
...
80105aa5:	74 0c                	je     80105ab3 <sys_unlink+0x15a>
    panic("unlink: writei");
80105aa7:	c7 04 24 15 87 10 80 	movl   $0x80108715,(%esp)
...
80105c01:	75 0c                	jne    80105c0f <create+0xde>
    panic("create: ialloc");
80105c03:	c7 04 24 24 87 10 80 	movl   $0x80108724,(%esp)
...
80105c71:	c7 44 24 04 fe 86 10 	movl   $0x801086fe,0x4(%esp)
80105c78:	80 
...
80105c92:	c7 44 24 04 00 87 10 	movl   $0x80108700,0x4(%esp)
80105c99:	80 
...
80105ca7:	79 0c                	jns    80105cb5 <create+0x184>
      panic("create dots");
80105ca9:	c7 04 24 33 87 10 80 	movl   $0x80108733,(%esp)
...
80105cd5:	c7 04 24 3f 87 10 80 	movl   $0x8010873f,(%esp)
...
801063a3:	83 ec 18             	sub    $0x18,%esp
  cprintf("hello world!\n");
801063a6:	c7 04 24 4f 87 10 80 	movl   $0x8010874f,(%esp)
...
801063bc:	83 ec 28             	sub    $0x28,%esp
  int n = 1;
801063bf:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
  if (argint(0, &n) < 0) {
801063c6:	8d 45 f4             	lea    -0xc(%ebp),%eax
801063c9:	89 44 24 04          	mov    %eax,0x4(%esp)
801063cd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801063d4:	e8 7a ef ff ff       	call   80105353 <argint>
801063d9:	85 c0                	test   %eax,%eax
801063db:	79 11                	jns    801063ee <sys_fkc+0x35>
    forkCount = 0;
801063dd:	c7 05 24 b6 10 80 00 	movl   $0x0,0x8010b624
801063e4:	00 00 00 
    return 0;
801063e7:	b8 00 00 00 00       	mov    $0x0,%eax
801063ec:	eb 1d                	jmp    8010640b <sys_fkc+0x52>
  }
  if (n == 0) {
801063ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063f1:	85 c0                	test   %eax,%eax
801063f3:	75 11                	jne    80106406 <sys_fkc+0x4d>
    forkCount = 0;
801063f5:	c7 05 24 b6 10 80 00 	movl   $0x0,0x8010b624
801063fc:	00 00 00 
    return 0;
801063ff:	b8 00 00 00 00       	mov    $0x0,%eax
80106404:	eb 05                	jmp    8010640b <sys_fkc+0x52>
  } 
  return forkCount;
80106406:	a1 24 b6 10 80       	mov    0x8010b624,%eax
}
8010640b:	c9                   	leave  
8010640c:	c3                   	ret    
...
8010641c:	54                   	push   %esp
  call trap
8010641d:	e8 d8 01 00 00       	call   801065fa <trap>
  addl $4, %esp
...
80106433:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80106436:	8b 45 0c             	mov    0xc(%ebp),%eax
80106439:	83 e8 01             	sub    $0x1,%eax
8010643c:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106440:	8b 45 08             	mov    0x8(%ebp),%eax
80106443:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106447:	8b 45 08             	mov    0x8(%ebp),%eax
8010644a:	c1 e8 10             	shr    $0x10,%eax
8010644d:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80106451:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106454:	0f 01 18             	lidtl  (%eax)
}
80106457:	c9                   	leave  
80106458:	c3                   	ret    
...
8010645f:	0f 20 d0             	mov    %cr2,%eax
80106462:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
80106465:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80106468:	c9                   	leave  
80106469:	c3                   	ret    
...
8010646d:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106470:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106477:	e9 c3 00 00 00       	jmp    8010653f <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
8010647c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010647f:	8b 04 85 80 b0 10 80 	mov    -0x7fef4f80(,%eax,4),%eax
80106486:	89 c2                	mov    %eax,%edx
80106488:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010648b:	66 89 14 c5 20 5d 11 	mov    %dx,-0x7feea2e0(,%eax,8)
80106492:	80 
80106493:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106496:	66 c7 04 c5 22 5d 11 	movw   $0x8,-0x7feea2de(,%eax,8)
8010649d:	80 08 00 
801064a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064a3:	0f b6 14 c5 24 5d 11 	movzbl -0x7feea2dc(,%eax,8),%edx
801064aa:	80 
801064ab:	83 e2 e0             	and    $0xffffffe0,%edx
801064ae:	88 14 c5 24 5d 11 80 	mov    %dl,-0x7feea2dc(,%eax,8)
801064b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064b8:	0f b6 14 c5 24 5d 11 	movzbl -0x7feea2dc(,%eax,8),%edx
801064bf:	80 
801064c0:	83 e2 1f             	and    $0x1f,%edx
801064c3:	88 14 c5 24 5d 11 80 	mov    %dl,-0x7feea2dc(,%eax,8)
801064ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064cd:	0f b6 14 c5 25 5d 11 	movzbl -0x7feea2db(,%eax,8),%edx
801064d4:	80 
801064d5:	83 e2 f0             	and    $0xfffffff0,%edx
801064d8:	83 ca 0e             	or     $0xe,%edx
801064db:	88 14 c5 25 5d 11 80 	mov    %dl,-0x7feea2db(,%eax,8)
801064e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064e5:	0f b6 14 c5 25 5d 11 	movzbl -0x7feea2db(,%eax,8),%edx
801064ec:	80 
801064ed:	83 e2 ef             	and    $0xffffffef,%edx
801064f0:	88 14 c5 25 5d 11 80 	mov    %dl,-0x7feea2db(,%eax,8)
801064f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064fa:	0f b6 14 c5 25 5d 11 	movzbl -0x7feea2db(,%eax,8),%edx
80106501:	80 
80106502:	83 e2 9f             	and    $0xffffff9f,%edx
80106505:	88 14 c5 25 5d 11 80 	mov    %dl,-0x7feea2db(,%eax,8)
8010650c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010650f:	0f b6 14 c5 25 5d 11 	movzbl -0x7feea2db(,%eax,8),%edx
80106516:	80 
80106517:	83 ca 80             	or     $0xffffff80,%edx
8010651a:	88 14 c5 25 5d 11 80 	mov    %dl,-0x7feea2db(,%eax,8)
80106521:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106524:	8b 04 85 80 b0 10 80 	mov    -0x7fef4f80(,%eax,4),%eax
8010652b:	c1 e8 10             	shr    $0x10,%eax
8010652e:	89 c2                	mov    %eax,%edx
80106530:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106533:	66 89 14 c5 26 5d 11 	mov    %dx,-0x7feea2da(,%eax,8)
8010653a:	80 
  for(i = 0; i < 256; i++)
8010653b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010653f:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106546:	0f 8e 30 ff ff ff    	jle    8010647c <tvinit+0x12>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010654c:	a1 80 b1 10 80       	mov    0x8010b180,%eax
80106551:	66 a3 20 5f 11 80    	mov    %ax,0x80115f20
80106557:	66 c7 05 22 5f 11 80 	movw   $0x8,0x80115f22
8010655e:	08 00 
80106560:	0f b6 05 24 5f 11 80 	movzbl 0x80115f24,%eax
80106567:	83 e0 e0             	and    $0xffffffe0,%eax
8010656a:	a2 24 5f 11 80       	mov    %al,0x80115f24
8010656f:	0f b6 05 24 5f 11 80 	movzbl 0x80115f24,%eax
80106576:	83 e0 1f             	and    $0x1f,%eax
80106579:	a2 24 5f 11 80       	mov    %al,0x80115f24
8010657e:	0f b6 05 25 5f 11 80 	movzbl 0x80115f25,%eax
80106585:	83 c8 0f             	or     $0xf,%eax
80106588:	a2 25 5f 11 80       	mov    %al,0x80115f25
8010658d:	0f b6 05 25 5f 11 80 	movzbl 0x80115f25,%eax
80106594:	83 e0 ef             	and    $0xffffffef,%eax
80106597:	a2 25 5f 11 80       	mov    %al,0x80115f25
8010659c:	0f b6 05 25 5f 11 80 	movzbl 0x80115f25,%eax
801065a3:	83 c8 60             	or     $0x60,%eax
801065a6:	a2 25 5f 11 80       	mov    %al,0x80115f25
801065ab:	0f b6 05 25 5f 11 80 	movzbl 0x80115f25,%eax
801065b2:	83 c8 80             	or     $0xffffff80,%eax
801065b5:	a2 25 5f 11 80       	mov    %al,0x80115f25
801065ba:	a1 80 b1 10 80       	mov    0x8010b180,%eax
801065bf:	c1 e8 10             	shr    $0x10,%eax
801065c2:	66 a3 26 5f 11 80    	mov    %ax,0x80115f26

  initlock(&tickslock, "time");
801065c8:	c7 44 24 04 60 87 10 	movl   $0x80108760,0x4(%esp)
801065cf:	80 
801065d0:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
801065d7:	e8 9b e7 ff ff       	call   80104d77 <initlock>
}
801065dc:	c9                   	leave  
801065dd:	c3                   	ret    
...
801065e1:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801065e4:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801065eb:	00 
801065ec:	c7 04 24 20 5d 11 80 	movl   $0x80115d20,(%esp)
801065f3:	e8 38 fe ff ff       	call   80106430 <lidt>
}
801065f8:	c9                   	leave  
801065f9:	c3                   	ret    
...
80106600:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106603:	8b 45 08             	mov    0x8(%ebp),%eax
80106606:	8b 40 30             	mov    0x30(%eax),%eax
80106609:	83 f8 40             	cmp    $0x40,%eax
8010660c:	75 3c                	jne    8010664a <trap+0x50>
    if(myproc()->killed)
8010660e:	e8 4e db ff ff       	call   80104161 <myproc>
80106613:	8b 40 24             	mov    0x24(%eax),%eax
80106616:	85 c0                	test   %eax,%eax
80106618:	74 05                	je     8010661f <trap+0x25>
      exit();
8010661a:	e8 a7 df ff ff       	call   801045c6 <exit>
    myproc()->tf = tf;
8010661f:	e8 3d db ff ff       	call   80104161 <myproc>
80106624:	8b 55 08             	mov    0x8(%ebp),%edx
80106627:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
8010662a:	e8 f2 ed ff ff       	call   80105421 <syscall>
    if(myproc()->killed)
8010662f:	e8 2d db ff ff       	call   80104161 <myproc>
80106634:	8b 40 24             	mov    0x24(%eax),%eax
80106637:	85 c0                	test   %eax,%eax
80106639:	74 0a                	je     80106645 <trap+0x4b>
      exit();
8010663b:	e8 86 df ff ff       	call   801045c6 <exit>
    return;
80106640:	e9 19 02 00 00       	jmp    8010685e <trap+0x264>
80106645:	e9 14 02 00 00       	jmp    8010685e <trap+0x264>
  }

  switch(tf->trapno){
8010664a:	8b 45 08             	mov    0x8(%ebp),%eax
8010664d:	8b 40 30             	mov    0x30(%eax),%eax
80106650:	83 e8 20             	sub    $0x20,%eax
80106653:	83 f8 1f             	cmp    $0x1f,%eax
80106656:	0f 87 b1 00 00 00    	ja     8010670d <trap+0x113>
8010665c:	8b 04 85 08 88 10 80 	mov    -0x7fef77f8(,%eax,4),%eax
80106663:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80106665:	e8 60 da ff ff       	call   801040ca <cpuid>
8010666a:	85 c0                	test   %eax,%eax
8010666c:	75 31                	jne    8010669f <trap+0xa5>
      acquire(&tickslock);
8010666e:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
80106675:	e8 1e e7 ff ff       	call   80104d98 <acquire>
      ticks++;
8010667a:	a1 20 65 11 80       	mov    0x80116520,%eax
8010667f:	83 c0 01             	add    $0x1,%eax
80106682:	a3 20 65 11 80       	mov    %eax,0x80116520
      wakeup(&ticks);
80106687:	c7 04 24 20 65 11 80 	movl   $0x80116520,(%esp)
8010668e:	e8 e7 e3 ff ff       	call   80104a7a <wakeup>
      release(&tickslock);
80106693:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
8010669a:	e8 61 e7 ff ff       	call   80104e00 <release>
    }
    lapiceoi();
8010669f:	e8 ad c8 ff ff       	call   80102f51 <lapiceoi>
    break;
801066a4:	e9 37 01 00 00       	jmp    801067e0 <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801066a9:	e8 1a c1 ff ff       	call   801027c8 <ideintr>
    lapiceoi();
801066ae:	e8 9e c8 ff ff       	call   80102f51 <lapiceoi>
    break;
801066b3:	e9 28 01 00 00       	jmp    801067e0 <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801066b8:	e8 a9 c6 ff ff       	call   80102d66 <kbdintr>
    lapiceoi();
801066bd:	e8 8f c8 ff ff       	call   80102f51 <lapiceoi>
    break;
801066c2:	e9 19 01 00 00       	jmp    801067e0 <trap+0x1e6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801066c7:	e8 7b 03 00 00       	call   80106a47 <uartintr>
    lapiceoi();
801066cc:	e8 80 c8 ff ff       	call   80102f51 <lapiceoi>
    break;
801066d1:	e9 0a 01 00 00       	jmp    801067e0 <trap+0x1e6>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801066d6:	8b 45 08             	mov    0x8(%ebp),%eax
801066d9:	8b 70 38             	mov    0x38(%eax),%esi
            cpuid(), tf->cs, tf->eip);
801066dc:	8b 45 08             	mov    0x8(%ebp),%eax
801066df:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801066e3:	0f b7 d8             	movzwl %ax,%ebx
801066e6:	e8 df d9 ff ff       	call   801040ca <cpuid>
801066eb:	89 74 24 0c          	mov    %esi,0xc(%esp)
801066ef:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801066f3:	89 44 24 04          	mov    %eax,0x4(%esp)
801066f7:	c7 04 24 68 87 10 80 	movl   $0x80108768,(%esp)
801066fe:	e8 c5 9c ff ff       	call   801003c8 <cprintf>
    lapiceoi();
80106703:	e8 49 c8 ff ff       	call   80102f51 <lapiceoi>
    break;
80106708:	e9 d3 00 00 00       	jmp    801067e0 <trap+0x1e6>

  //PAGEBREAK: 13
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
8010670d:	e8 4f da ff ff       	call   80104161 <myproc>
80106712:	85 c0                	test   %eax,%eax
80106714:	74 11                	je     80106727 <trap+0x12d>
80106716:	8b 45 08             	mov    0x8(%ebp),%eax
80106719:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
8010671d:	0f b7 c0             	movzwl %ax,%eax
80106720:	83 e0 03             	and    $0x3,%eax
80106723:	85 c0                	test   %eax,%eax
80106725:	75 40                	jne    80106767 <trap+0x16d>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106727:	e8 2d fd ff ff       	call   80106459 <rcr2>
8010672c:	89 c3                	mov    %eax,%ebx
8010672e:	8b 45 08             	mov    0x8(%ebp),%eax
80106731:	8b 70 38             	mov    0x38(%eax),%esi
80106734:	e8 91 d9 ff ff       	call   801040ca <cpuid>
80106739:	8b 55 08             	mov    0x8(%ebp),%edx
8010673c:	8b 52 30             	mov    0x30(%edx),%edx
8010673f:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106743:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106747:	89 44 24 08          	mov    %eax,0x8(%esp)
8010674b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010674f:	c7 04 24 8c 87 10 80 	movl   $0x8010878c,(%esp)
80106756:	e8 6d 9c ff ff       	call   801003c8 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
8010675b:	c7 04 24 be 87 10 80 	movl   $0x801087be,(%esp)
80106762:	e8 fb 9d ff ff       	call   80100562 <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106767:	e8 ed fc ff ff       	call   80106459 <rcr2>
8010676c:	89 c6                	mov    %eax,%esi
8010676e:	8b 45 08             	mov    0x8(%ebp),%eax
80106771:	8b 40 38             	mov    0x38(%eax),%eax
80106774:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106777:	e8 4e d9 ff ff       	call   801040ca <cpuid>
8010677c:	89 c3                	mov    %eax,%ebx
8010677e:	8b 45 08             	mov    0x8(%ebp),%eax
80106781:	8b 78 34             	mov    0x34(%eax),%edi
80106784:	89 7d e0             	mov    %edi,-0x20(%ebp)
80106787:	8b 45 08             	mov    0x8(%ebp),%eax
8010678a:	8b 78 30             	mov    0x30(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010678d:	e8 cf d9 ff ff       	call   80104161 <myproc>
80106792:	8d 50 6c             	lea    0x6c(%eax),%edx
80106795:	89 55 dc             	mov    %edx,-0x24(%ebp)
80106798:	e8 c4 d9 ff ff       	call   80104161 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010679d:	8b 40 10             	mov    0x10(%eax),%eax
801067a0:	89 74 24 1c          	mov    %esi,0x1c(%esp)
801067a4:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801067a7:	89 4c 24 18          	mov    %ecx,0x18(%esp)
801067ab:	89 5c 24 14          	mov    %ebx,0x14(%esp)
801067af:	8b 4d e0             	mov    -0x20(%ebp),%ecx
801067b2:	89 4c 24 10          	mov    %ecx,0x10(%esp)
801067b6:	89 7c 24 0c          	mov    %edi,0xc(%esp)
801067ba:	8b 55 dc             	mov    -0x24(%ebp),%edx
801067bd:	89 54 24 08          	mov    %edx,0x8(%esp)
801067c1:	89 44 24 04          	mov    %eax,0x4(%esp)
801067c5:	c7 04 24 c4 87 10 80 	movl   $0x801087c4,(%esp)
801067cc:	e8 f7 9b ff ff       	call   801003c8 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801067d1:	e8 8b d9 ff ff       	call   80104161 <myproc>
801067d6:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801067dd:	eb 01                	jmp    801067e0 <trap+0x1e6>
    break;
801067df:	90                   	nop
  }
...
801067e7:	74 23                	je     8010680c <trap+0x212>
801067e9:	e8 73 d9 ff ff       	call   80104161 <myproc>
801067ee:	8b 40 24             	mov    0x24(%eax),%eax
801067f1:	85 c0                	test   %eax,%eax
801067f3:	74 17                	je     8010680c <trap+0x212>
...
80106802:	83 f8 03             	cmp    $0x3,%eax
80106805:	75 05                	jne    8010680c <trap+0x212>
    exit();
80106807:	e8 ba dd ff ff       	call   801045c6 <exit>
...
80106813:	74 1d                	je     80106832 <trap+0x238>
80106815:	e8 47 d9 ff ff       	call   80104161 <myproc>
8010681a:	8b 40 0c             	mov    0xc(%eax),%eax
8010681d:	83 f8 04             	cmp    $0x4,%eax
80106820:	75 10                	jne    80106832 <trap+0x238>
     tf->trapno == T_IRQ0+IRQ_TIMER)
80106822:	8b 45 08             	mov    0x8(%ebp),%eax
80106825:	8b 40 30             	mov    0x30(%eax),%eax
  if(myproc() && myproc()->state == RUNNING &&
80106828:	83 f8 20             	cmp    $0x20,%eax
8010682b:	75 05                	jne    80106832 <trap+0x238>
    yield();
8010682d:	e8 04 e1 ff ff       	call   80104936 <yield>

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106832:	e8 2a d9 ff ff       	call   80104161 <myproc>
80106837:	85 c0                	test   %eax,%eax
80106839:	74 23                	je     8010685e <trap+0x264>
8010683b:	e8 21 d9 ff ff       	call   80104161 <myproc>
80106840:	8b 40 24             	mov    0x24(%eax),%eax
80106843:	85 c0                	test   %eax,%eax
80106845:	74 17                	je     8010685e <trap+0x264>
...
80106857:	75 05                	jne    8010685e <trap+0x264>
    exit();
80106859:	e8 68 dd ff ff       	call   801045c6 <exit>
}
8010685e:	83 c4 3c             	add    $0x3c,%esp
80106861:	5b                   	pop    %ebx
80106862:	5e                   	pop    %esi
80106863:	5f                   	pop    %edi
80106864:	5d                   	pop    %ebp
...
80106869:	83 ec 14             	sub    $0x14,%esp
8010686c:	8b 45 08             	mov    0x8(%ebp),%eax
8010686f:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106873:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106877:	89 c2                	mov    %eax,%edx
80106879:	ec                   	in     (%dx),%al
8010687a:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
8010687d:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106881:	c9                   	leave  
80106882:	c3                   	ret    
...
80106886:	83 ec 08             	sub    $0x8,%esp
80106889:	8b 55 08             	mov    0x8(%ebp),%edx
8010688c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010688f:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106893:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106896:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
...
801068a4:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
801068a7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801068ae:	00 
801068af:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801068b6:	e8 c8 ff ff ff       	call   80106883 <outb>

  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
801068bb:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
801068c2:	00 
801068c3:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801068ca:	e8 b4 ff ff ff       	call   80106883 <outb>
  outb(COM1+0, 115200/9600);
801068cf:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801068d6:	00 
801068d7:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801068de:	e8 a0 ff ff ff       	call   80106883 <outb>
  outb(COM1+1, 0);
801068e3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801068ea:	00 
801068eb:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801068f2:	e8 8c ff ff ff       	call   80106883 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
801068f7:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801068fe:	00 
801068ff:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106906:	e8 78 ff ff ff       	call   80106883 <outb>
  outb(COM1+4, 0);
8010690b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106912:	00 
80106913:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
8010691a:	e8 64 ff ff ff       	call   80106883 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
8010691f:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106926:	00 
80106927:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
8010692e:	e8 50 ff ff ff       	call   80106883 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106933:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
8010693a:	e8 27 ff ff ff       	call   80106866 <inb>
8010693f:	3c ff                	cmp    $0xff,%al
80106941:	75 02                	jne    80106945 <uartinit+0xa4>
    return;
80106943:	eb 5e                	jmp    801069a3 <uartinit+0x102>
  uart = 1;
80106945:	c7 05 28 b6 10 80 01 	movl   $0x1,0x8010b628
8010694c:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
8010694f:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106956:	e8 0b ff ff ff       	call   80106866 <inb>
  inb(COM1+0);
8010695b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106962:	e8 ff fe ff ff       	call   80106866 <inb>
  ioapicenable(IRQ_COM1, 0);
80106967:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010696e:	00 
8010696f:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106976:	e8 c4 c0 ff ff       	call   80102a3f <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010697b:	c7 45 f4 88 88 10 80 	movl   $0x80108888,-0xc(%ebp)
80106982:	eb 15                	jmp    80106999 <uartinit+0xf8>
    uartputc(*p);
...
80106990:	e8 10 00 00 00       	call   801069a5 <uartputc>
  for(p="xv6...\n"; *p; p++)
80106995:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106999:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010699c:	0f b6 00             	movzbl (%eax),%eax
8010699f:	84 c0                	test   %al,%al
801069a1:	75 e1                	jne    80106984 <uartinit+0xe3>
}
801069a3:	c9                   	leave  
801069a4:	c3                   	ret    
...
801069a8:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
801069ab:	a1 28 b6 10 80       	mov    0x8010b628,%eax
801069b0:	85 c0                	test   %eax,%eax
801069b2:	75 02                	jne    801069b6 <uartputc+0x11>
    return;
801069b4:	eb 4b                	jmp    80106a01 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801069b6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801069bd:	eb 10                	jmp    801069cf <uartputc+0x2a>
    microdelay(10);
801069bf:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801069c6:	e8 ab c5 ff ff       	call   80102f76 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801069cb:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801069cf:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801069d3:	7f 16                	jg     801069eb <uartputc+0x46>
801069d5:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801069dc:	e8 85 fe ff ff       	call   80106866 <inb>
801069e1:	0f b6 c0             	movzbl %al,%eax
801069e4:	83 e0 20             	and    $0x20,%eax
801069e7:	85 c0                	test   %eax,%eax
801069e9:	74 d4                	je     801069bf <uartputc+0x1a>
  outb(COM1+0, c);
801069eb:	8b 45 08             	mov    0x8(%ebp),%eax
801069ee:	0f b6 c0             	movzbl %al,%eax
801069f1:	89 44 24 04          	mov    %eax,0x4(%esp)
801069f5:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801069fc:	e8 82 fe ff ff       	call   80106883 <outb>
}
80106a01:	c9                   	leave  
80106a02:	c3                   	ret    
...
80106a06:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106a09:	a1 28 b6 10 80       	mov    0x8010b628,%eax
80106a0e:	85 c0                	test   %eax,%eax
80106a10:	75 07                	jne    80106a19 <uartgetc+0x16>
    return -1;
80106a12:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a17:	eb 2c                	jmp    80106a45 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106a19:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106a20:	e8 41 fe ff ff       	call   80106866 <inb>
80106a25:	0f b6 c0             	movzbl %al,%eax
80106a28:	83 e0 01             	and    $0x1,%eax
80106a2b:	85 c0                	test   %eax,%eax
80106a2d:	75 07                	jne    80106a36 <uartgetc+0x33>
    return -1;
80106a2f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a34:	eb 0f                	jmp    80106a45 <uartgetc+0x42>
  return inb(COM1+0);
80106a36:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106a3d:	e8 24 fe ff ff       	call   80106866 <inb>
...
80106a4d:	c7 04 24 03 6a 10 80 	movl   $0x80106a03,(%esp)
80106a54:	e8 90 9d ff ff       	call   801007e9 <consoleintr>
}
80106a59:	c9                   	leave  
80106a5a:	c3                   	ret    
...
80106a5d:	6a 00                	push   $0x0
  jmp alltraps
80106a5f:	e9 a9 f9 ff ff       	jmp    8010640d <alltraps>
...
80106a66:	6a 01                	push   $0x1
  jmp alltraps
80106a68:	e9 a0 f9 ff ff       	jmp    8010640d <alltraps>
...
80106a6d:	6a 00                	push   $0x0
  pushl $2
80106a6f:	6a 02                	push   $0x2
  jmp alltraps
80106a71:	e9 97 f9 ff ff       	jmp    8010640d <alltraps>
...
80106a76:	6a 00                	push   $0x0
  pushl $3
80106a78:	6a 03                	push   $0x3
  jmp alltraps
80106a7a:	e9 8e f9 ff ff       	jmp    8010640d <alltraps>
...
80106a7f:	6a 00                	push   $0x0
  pushl $4
80106a81:	6a 04                	push   $0x4
  jmp alltraps
80106a83:	e9 85 f9 ff ff       	jmp    8010640d <alltraps>
...
80106a88:	6a 00                	push   $0x0
  pushl $5
80106a8a:	6a 05                	push   $0x5
  jmp alltraps
80106a8c:	e9 7c f9 ff ff       	jmp    8010640d <alltraps>
...
80106a91:	6a 00                	push   $0x0
  pushl $6
80106a93:	6a 06                	push   $0x6
  jmp alltraps
80106a95:	e9 73 f9 ff ff       	jmp    8010640d <alltraps>
...
80106a9a:	6a 00                	push   $0x0
  pushl $7
80106a9c:	6a 07                	push   $0x7
  jmp alltraps
80106a9e:	e9 6a f9 ff ff       	jmp    8010640d <alltraps>

80106aa3 <vector8>:
.globl vector8
vector8:
  pushl $8
80106aa3:	6a 08                	push   $0x8
  jmp alltraps
80106aa5:	e9 63 f9 ff ff       	jmp    8010640d <alltraps>
...
80106aaa:	6a 00                	push   $0x0
  pushl $9
80106aac:	6a 09                	push   $0x9
  jmp alltraps
80106aae:	e9 5a f9 ff ff       	jmp    8010640d <alltraps>
...
80106ab3:	6a 0a                	push   $0xa
  jmp alltraps
80106ab5:	e9 53 f9 ff ff       	jmp    8010640d <alltraps>

80106aba <vector11>:
.globl vector11
vector11:
  pushl $11
80106aba:	6a 0b                	push   $0xb
  jmp alltraps
80106abc:	e9 4c f9 ff ff       	jmp    8010640d <alltraps>

80106ac1 <vector12>:
.globl vector12
vector12:
  pushl $12
80106ac1:	6a 0c                	push   $0xc
  jmp alltraps
...
vector13:
  pushl $13
80106ac8:	6a 0d                	push   $0xd
  jmp alltraps
80106aca:	e9 3e f9 ff ff       	jmp    8010640d <alltraps>

80106acf <vector14>:
.globl vector14
vector14:
  pushl $14
80106acf:	6a 0e                	push   $0xe
  jmp alltraps
80106ad1:	e9 37 f9 ff ff       	jmp    8010640d <alltraps>
...
80106ad6:	6a 00                	push   $0x0
  pushl $15
80106ad8:	6a 0f                	push   $0xf
  jmp alltraps
80106ada:	e9 2e f9 ff ff       	jmp    8010640d <alltraps>
...
80106adf:	6a 00                	push   $0x0
  pushl $16
80106ae1:	6a 10                	push   $0x10
  jmp alltraps
80106ae3:	e9 25 f9 ff ff       	jmp    8010640d <alltraps>

80106ae8 <vector17>:
.globl vector17
vector17:
  pushl $17
80106ae8:	6a 11                	push   $0x11
  jmp alltraps
80106aea:	e9 1e f9 ff ff       	jmp    8010640d <alltraps>
...
80106aef:	6a 00                	push   $0x0
  pushl $18
80106af1:	6a 12                	push   $0x12
  jmp alltraps
80106af3:	e9 15 f9 ff ff       	jmp    8010640d <alltraps>
...
80106af8:	6a 00                	push   $0x0
  pushl $19
80106afa:	6a 13                	push   $0x13
  jmp alltraps
80106afc:	e9 0c f9 ff ff       	jmp    8010640d <alltraps>
...
80106b01:	6a 00                	push   $0x0
  pushl $20
80106b03:	6a 14                	push   $0x14
  jmp alltraps
80106b05:	e9 03 f9 ff ff       	jmp    8010640d <alltraps>
...
80106b0a:	6a 00                	push   $0x0
  pushl $21
80106b0c:	6a 15                	push   $0x15
  jmp alltraps
80106b0e:	e9 fa f8 ff ff       	jmp    8010640d <alltraps>
...
80106b13:	6a 00                	push   $0x0
  pushl $22
80106b15:	6a 16                	push   $0x16
  jmp alltraps
80106b17:	e9 f1 f8 ff ff       	jmp    8010640d <alltraps>
...
80106b1c:	6a 00                	push   $0x0
  pushl $23
80106b1e:	6a 17                	push   $0x17
  jmp alltraps
80106b20:	e9 e8 f8 ff ff       	jmp    8010640d <alltraps>
...
80106b25:	6a 00                	push   $0x0
  pushl $24
80106b27:	6a 18                	push   $0x18
  jmp alltraps
80106b29:	e9 df f8 ff ff       	jmp    8010640d <alltraps>
...
80106b2e:	6a 00                	push   $0x0
  pushl $25
80106b30:	6a 19                	push   $0x19
  jmp alltraps
80106b32:	e9 d6 f8 ff ff       	jmp    8010640d <alltraps>
...
80106b37:	6a 00                	push   $0x0
  pushl $26
80106b39:	6a 1a                	push   $0x1a
  jmp alltraps
80106b3b:	e9 cd f8 ff ff       	jmp    8010640d <alltraps>
...
80106b40:	6a 00                	push   $0x0
  pushl $27
80106b42:	6a 1b                	push   $0x1b
  jmp alltraps
80106b44:	e9 c4 f8 ff ff       	jmp    8010640d <alltraps>
...
80106b49:	6a 00                	push   $0x0
  pushl $28
80106b4b:	6a 1c                	push   $0x1c
  jmp alltraps
80106b4d:	e9 bb f8 ff ff       	jmp    8010640d <alltraps>
...
80106b52:	6a 00                	push   $0x0
  pushl $29
80106b54:	6a 1d                	push   $0x1d
  jmp alltraps
80106b56:	e9 b2 f8 ff ff       	jmp    8010640d <alltraps>
...
80106b5b:	6a 00                	push   $0x0
  pushl $30
80106b5d:	6a 1e                	push   $0x1e
  jmp alltraps
80106b5f:	e9 a9 f8 ff ff       	jmp    8010640d <alltraps>
...
80106b64:	6a 00                	push   $0x0
  pushl $31
80106b66:	6a 1f                	push   $0x1f
  jmp alltraps
80106b68:	e9 a0 f8 ff ff       	jmp    8010640d <alltraps>
...
80106b6d:	6a 00                	push   $0x0
  pushl $32
80106b6f:	6a 20                	push   $0x20
  jmp alltraps
80106b71:	e9 97 f8 ff ff       	jmp    8010640d <alltraps>
...
80106b76:	6a 00                	push   $0x0
  pushl $33
80106b78:	6a 21                	push   $0x21
  jmp alltraps
80106b7a:	e9 8e f8 ff ff       	jmp    8010640d <alltraps>
...
80106b7f:	6a 00                	push   $0x0
  pushl $34
80106b81:	6a 22                	push   $0x22
  jmp alltraps
80106b83:	e9 85 f8 ff ff       	jmp    8010640d <alltraps>
...
80106b88:	6a 00                	push   $0x0
  pushl $35
80106b8a:	6a 23                	push   $0x23
  jmp alltraps
80106b8c:	e9 7c f8 ff ff       	jmp    8010640d <alltraps>
...
80106b91:	6a 00                	push   $0x0
  pushl $36
80106b93:	6a 24                	push   $0x24
  jmp alltraps
80106b95:	e9 73 f8 ff ff       	jmp    8010640d <alltraps>
...
80106b9a:	6a 00                	push   $0x0
  pushl $37
80106b9c:	6a 25                	push   $0x25
  jmp alltraps
80106b9e:	e9 6a f8 ff ff       	jmp    8010640d <alltraps>
...
80106ba3:	6a 00                	push   $0x0
  pushl $38
80106ba5:	6a 26                	push   $0x26
  jmp alltraps
80106ba7:	e9 61 f8 ff ff       	jmp    8010640d <alltraps>
...
80106bac:	6a 00                	push   $0x0
  pushl $39
80106bae:	6a 27                	push   $0x27
  jmp alltraps
80106bb0:	e9 58 f8 ff ff       	jmp    8010640d <alltraps>
...
80106bb5:	6a 00                	push   $0x0
  pushl $40
80106bb7:	6a 28                	push   $0x28
  jmp alltraps
80106bb9:	e9 4f f8 ff ff       	jmp    8010640d <alltraps>
...
80106bbe:	6a 00                	push   $0x0
  pushl $41
80106bc0:	6a 29                	push   $0x29
  jmp alltraps
80106bc2:	e9 46 f8 ff ff       	jmp    8010640d <alltraps>
...
80106bc7:	6a 00                	push   $0x0
  pushl $42
80106bc9:	6a 2a                	push   $0x2a
  jmp alltraps
80106bcb:	e9 3d f8 ff ff       	jmp    8010640d <alltraps>
...
80106bd0:	6a 00                	push   $0x0
  pushl $43
80106bd2:	6a 2b                	push   $0x2b
  jmp alltraps
80106bd4:	e9 34 f8 ff ff       	jmp    8010640d <alltraps>
...
80106bd9:	6a 00                	push   $0x0
  pushl $44
80106bdb:	6a 2c                	push   $0x2c
  jmp alltraps
80106bdd:	e9 2b f8 ff ff       	jmp    8010640d <alltraps>
...
80106be2:	6a 00                	push   $0x0
  pushl $45
80106be4:	6a 2d                	push   $0x2d
  jmp alltraps
80106be6:	e9 22 f8 ff ff       	jmp    8010640d <alltraps>
...
80106beb:	6a 00                	push   $0x0
  pushl $46
80106bed:	6a 2e                	push   $0x2e
  jmp alltraps
80106bef:	e9 19 f8 ff ff       	jmp    8010640d <alltraps>
...
80106bf4:	6a 00                	push   $0x0
  pushl $47
80106bf6:	6a 2f                	push   $0x2f
  jmp alltraps
80106bf8:	e9 10 f8 ff ff       	jmp    8010640d <alltraps>
...
80106bfd:	6a 00                	push   $0x0
  pushl $48
80106bff:	6a 30                	push   $0x30
  jmp alltraps
80106c01:	e9 07 f8 ff ff       	jmp    8010640d <alltraps>
...
80106c06:	6a 00                	push   $0x0
  pushl $49
80106c08:	6a 31                	push   $0x31
  jmp alltraps
80106c0a:	e9 fe f7 ff ff       	jmp    8010640d <alltraps>
...
80106c0f:	6a 00                	push   $0x0
  pushl $50
80106c11:	6a 32                	push   $0x32
  jmp alltraps
80106c13:	e9 f5 f7 ff ff       	jmp    8010640d <alltraps>
...
80106c18:	6a 00                	push   $0x0
  pushl $51
80106c1a:	6a 33                	push   $0x33
  jmp alltraps
80106c1c:	e9 ec f7 ff ff       	jmp    8010640d <alltraps>
...
80106c21:	6a 00                	push   $0x0
  pushl $52
80106c23:	6a 34                	push   $0x34
  jmp alltraps
80106c25:	e9 e3 f7 ff ff       	jmp    8010640d <alltraps>
...
80106c2a:	6a 00                	push   $0x0
  pushl $53
80106c2c:	6a 35                	push   $0x35
  jmp alltraps
80106c2e:	e9 da f7 ff ff       	jmp    8010640d <alltraps>
...
80106c33:	6a 00                	push   $0x0
  pushl $54
80106c35:	6a 36                	push   $0x36
  jmp alltraps
80106c37:	e9 d1 f7 ff ff       	jmp    8010640d <alltraps>
...
80106c3c:	6a 00                	push   $0x0
  pushl $55
80106c3e:	6a 37                	push   $0x37
  jmp alltraps
80106c40:	e9 c8 f7 ff ff       	jmp    8010640d <alltraps>
...
80106c45:	6a 00                	push   $0x0
  pushl $56
80106c47:	6a 38                	push   $0x38
  jmp alltraps
80106c49:	e9 bf f7 ff ff       	jmp    8010640d <alltraps>
...
80106c4e:	6a 00                	push   $0x0
  pushl $57
80106c50:	6a 39                	push   $0x39
  jmp alltraps
80106c52:	e9 b6 f7 ff ff       	jmp    8010640d <alltraps>
...
80106c57:	6a 00                	push   $0x0
  pushl $58
80106c59:	6a 3a                	push   $0x3a
  jmp alltraps
80106c5b:	e9 ad f7 ff ff       	jmp    8010640d <alltraps>
...
80106c60:	6a 00                	push   $0x0
  pushl $59
80106c62:	6a 3b                	push   $0x3b
  jmp alltraps
80106c64:	e9 a4 f7 ff ff       	jmp    8010640d <alltraps>
...
80106c69:	6a 00                	push   $0x0
  pushl $60
80106c6b:	6a 3c                	push   $0x3c
  jmp alltraps
80106c6d:	e9 9b f7 ff ff       	jmp    8010640d <alltraps>
...
80106c72:	6a 00                	push   $0x0
  pushl $61
80106c74:	6a 3d                	push   $0x3d
  jmp alltraps
80106c76:	e9 92 f7 ff ff       	jmp    8010640d <alltraps>
...
80106c7b:	6a 00                	push   $0x0
  pushl $62
80106c7d:	6a 3e                	push   $0x3e
  jmp alltraps
80106c7f:	e9 89 f7 ff ff       	jmp    8010640d <alltraps>
...
80106c84:	6a 00                	push   $0x0
  pushl $63
80106c86:	6a 3f                	push   $0x3f
  jmp alltraps
80106c88:	e9 80 f7 ff ff       	jmp    8010640d <alltraps>
...
80106c8d:	6a 00                	push   $0x0
  pushl $64
80106c8f:	6a 40                	push   $0x40
  jmp alltraps
80106c91:	e9 77 f7 ff ff       	jmp    8010640d <alltraps>
...
80106c96:	6a 00                	push   $0x0
  pushl $65
80106c98:	6a 41                	push   $0x41
  jmp alltraps
80106c9a:	e9 6e f7 ff ff       	jmp    8010640d <alltraps>
...
80106c9f:	6a 00                	push   $0x0
  pushl $66
80106ca1:	6a 42                	push   $0x42
  jmp alltraps
80106ca3:	e9 65 f7 ff ff       	jmp    8010640d <alltraps>
...
80106ca8:	6a 00                	push   $0x0
  pushl $67
80106caa:	6a 43                	push   $0x43
  jmp alltraps
80106cac:	e9 5c f7 ff ff       	jmp    8010640d <alltraps>
...
80106cb1:	6a 00                	push   $0x0
  pushl $68
80106cb3:	6a 44                	push   $0x44
  jmp alltraps
80106cb5:	e9 53 f7 ff ff       	jmp    8010640d <alltraps>
...
80106cba:	6a 00                	push   $0x0
  pushl $69
80106cbc:	6a 45                	push   $0x45
  jmp alltraps
80106cbe:	e9 4a f7 ff ff       	jmp    8010640d <alltraps>
...
80106cc3:	6a 00                	push   $0x0
  pushl $70
80106cc5:	6a 46                	push   $0x46
  jmp alltraps
80106cc7:	e9 41 f7 ff ff       	jmp    8010640d <alltraps>
...
80106ccc:	6a 00                	push   $0x0
  pushl $71
80106cce:	6a 47                	push   $0x47
  jmp alltraps
80106cd0:	e9 38 f7 ff ff       	jmp    8010640d <alltraps>
...
80106cd5:	6a 00                	push   $0x0
  pushl $72
80106cd7:	6a 48                	push   $0x48
  jmp alltraps
80106cd9:	e9 2f f7 ff ff       	jmp    8010640d <alltraps>
...
80106cde:	6a 00                	push   $0x0
  pushl $73
80106ce0:	6a 49                	push   $0x49
  jmp alltraps
80106ce2:	e9 26 f7 ff ff       	jmp    8010640d <alltraps>
...
80106ce7:	6a 00                	push   $0x0
  pushl $74
80106ce9:	6a 4a                	push   $0x4a
  jmp alltraps
80106ceb:	e9 1d f7 ff ff       	jmp    8010640d <alltraps>
...
80106cf0:	6a 00                	push   $0x0
  pushl $75
80106cf2:	6a 4b                	push   $0x4b
  jmp alltraps
80106cf4:	e9 14 f7 ff ff       	jmp    8010640d <alltraps>
...
80106cf9:	6a 00                	push   $0x0
  pushl $76
80106cfb:	6a 4c                	push   $0x4c
  jmp alltraps
80106cfd:	e9 0b f7 ff ff       	jmp    8010640d <alltraps>
...
80106d02:	6a 00                	push   $0x0
  pushl $77
80106d04:	6a 4d                	push   $0x4d
  jmp alltraps
80106d06:	e9 02 f7 ff ff       	jmp    8010640d <alltraps>
...
80106d0b:	6a 00                	push   $0x0
  pushl $78
80106d0d:	6a 4e                	push   $0x4e
  jmp alltraps
80106d0f:	e9 f9 f6 ff ff       	jmp    8010640d <alltraps>
...
80106d14:	6a 00                	push   $0x0
  pushl $79
80106d16:	6a 4f                	push   $0x4f
  jmp alltraps
80106d18:	e9 f0 f6 ff ff       	jmp    8010640d <alltraps>
...
80106d1d:	6a 00                	push   $0x0
  pushl $80
80106d1f:	6a 50                	push   $0x50
  jmp alltraps
80106d21:	e9 e7 f6 ff ff       	jmp    8010640d <alltraps>
...
80106d26:	6a 00                	push   $0x0
  pushl $81
80106d28:	6a 51                	push   $0x51
  jmp alltraps
80106d2a:	e9 de f6 ff ff       	jmp    8010640d <alltraps>
...
80106d2f:	6a 00                	push   $0x0
  pushl $82
80106d31:	6a 52                	push   $0x52
  jmp alltraps
80106d33:	e9 d5 f6 ff ff       	jmp    8010640d <alltraps>
...
80106d38:	6a 00                	push   $0x0
  pushl $83
80106d3a:	6a 53                	push   $0x53
  jmp alltraps
80106d3c:	e9 cc f6 ff ff       	jmp    8010640d <alltraps>
...
80106d41:	6a 00                	push   $0x0
  pushl $84
80106d43:	6a 54                	push   $0x54
  jmp alltraps
80106d45:	e9 c3 f6 ff ff       	jmp    8010640d <alltraps>
...
80106d4a:	6a 00                	push   $0x0
  pushl $85
80106d4c:	6a 55                	push   $0x55
  jmp alltraps
80106d4e:	e9 ba f6 ff ff       	jmp    8010640d <alltraps>
...
80106d53:	6a 00                	push   $0x0
  pushl $86
80106d55:	6a 56                	push   $0x56
  jmp alltraps
80106d57:	e9 b1 f6 ff ff       	jmp    8010640d <alltraps>
...
80106d5c:	6a 00                	push   $0x0
  pushl $87
80106d5e:	6a 57                	push   $0x57
  jmp alltraps
80106d60:	e9 a8 f6 ff ff       	jmp    8010640d <alltraps>
...
80106d65:	6a 00                	push   $0x0
  pushl $88
80106d67:	6a 58                	push   $0x58
  jmp alltraps
80106d69:	e9 9f f6 ff ff       	jmp    8010640d <alltraps>
...
80106d6e:	6a 00                	push   $0x0
  pushl $89
80106d70:	6a 59                	push   $0x59
  jmp alltraps
80106d72:	e9 96 f6 ff ff       	jmp    8010640d <alltraps>
...
80106d77:	6a 00                	push   $0x0
  pushl $90
80106d79:	6a 5a                	push   $0x5a
  jmp alltraps
80106d7b:	e9 8d f6 ff ff       	jmp    8010640d <alltraps>
...
80106d80:	6a 00                	push   $0x0
  pushl $91
80106d82:	6a 5b                	push   $0x5b
  jmp alltraps
80106d84:	e9 84 f6 ff ff       	jmp    8010640d <alltraps>
...
80106d92:	6a 00                	push   $0x0
  pushl $93
80106d94:	6a 5d                	push   $0x5d
  jmp alltraps
80106d96:	e9 72 f6 ff ff       	jmp    8010640d <alltraps>
...
80106d9b:	6a 00                	push   $0x0
  pushl $94
80106d9d:	6a 5e                	push   $0x5e
  jmp alltraps
80106d9f:	e9 69 f6 ff ff       	jmp    8010640d <alltraps>
...
80106da4:	6a 00                	push   $0x0
  pushl $95
80106da6:	6a 5f                	push   $0x5f
  jmp alltraps
80106da8:	e9 60 f6 ff ff       	jmp    8010640d <alltraps>
...
80106db6:	6a 00                	push   $0x0
  pushl $97
80106db8:	6a 61                	push   $0x61
  jmp alltraps
80106dba:	e9 4e f6 ff ff       	jmp    8010640d <alltraps>
...
80106dbf:	6a 00                	push   $0x0
  pushl $98
80106dc1:	6a 62                	push   $0x62
  jmp alltraps
80106dc3:	e9 45 f6 ff ff       	jmp    8010640d <alltraps>
...
80106dc8:	6a 00                	push   $0x0
  pushl $99
80106dca:	6a 63                	push   $0x63
  jmp alltraps
80106dcc:	e9 3c f6 ff ff       	jmp    8010640d <alltraps>
...
80106dda:	6a 00                	push   $0x0
  pushl $101
80106ddc:	6a 65                	push   $0x65
  jmp alltraps
80106dde:	e9 2a f6 ff ff       	jmp    8010640d <alltraps>
...
80106de3:	6a 00                	push   $0x0
  pushl $102
80106de5:	6a 66                	push   $0x66
  jmp alltraps
80106de7:	e9 21 f6 ff ff       	jmp    8010640d <alltraps>
...
80106dec:	6a 00                	push   $0x0
  pushl $103
80106dee:	6a 67                	push   $0x67
  jmp alltraps
80106df0:	e9 18 f6 ff ff       	jmp    8010640d <alltraps>
...
80106dfe:	6a 00                	push   $0x0
  pushl $105
80106e00:	6a 69                	push   $0x69
  jmp alltraps
80106e02:	e9 06 f6 ff ff       	jmp    8010640d <alltraps>
...
80106e07:	6a 00                	push   $0x0
  pushl $106
80106e09:	6a 6a                	push   $0x6a
  jmp alltraps
80106e0b:	e9 fd f5 ff ff       	jmp    8010640d <alltraps>
...
80106e10:	6a 00                	push   $0x0
  pushl $107
80106e12:	6a 6b                	push   $0x6b
  jmp alltraps
80106e14:	e9 f4 f5 ff ff       	jmp    8010640d <alltraps>
...
80106e22:	6a 00                	push   $0x0
  pushl $109
80106e24:	6a 6d                	push   $0x6d
  jmp alltraps
80106e26:	e9 e2 f5 ff ff       	jmp    8010640d <alltraps>
...
80106e2b:	6a 00                	push   $0x0
  pushl $110
80106e2d:	6a 6e                	push   $0x6e
  jmp alltraps
80106e2f:	e9 d9 f5 ff ff       	jmp    8010640d <alltraps>
...
80106e34:	6a 00                	push   $0x0
  pushl $111
80106e36:	6a 6f                	push   $0x6f
  jmp alltraps
80106e38:	e9 d0 f5 ff ff       	jmp    8010640d <alltraps>
...
80106e46:	6a 00                	push   $0x0
  pushl $113
80106e48:	6a 71                	push   $0x71
  jmp alltraps
80106e4a:	e9 be f5 ff ff       	jmp    8010640d <alltraps>
...
80106e4f:	6a 00                	push   $0x0
  pushl $114
80106e51:	6a 72                	push   $0x72
  jmp alltraps
80106e53:	e9 b5 f5 ff ff       	jmp    8010640d <alltraps>
...
80106e58:	6a 00                	push   $0x0
  pushl $115
80106e5a:	6a 73                	push   $0x73
  jmp alltraps
80106e5c:	e9 ac f5 ff ff       	jmp    8010640d <alltraps>
...
80106e6a:	6a 00                	push   $0x0
  pushl $117
80106e6c:	6a 75                	push   $0x75
  jmp alltraps
80106e6e:	e9 9a f5 ff ff       	jmp    8010640d <alltraps>
...
80106e73:	6a 00                	push   $0x0
  pushl $118
80106e75:	6a 76                	push   $0x76
  jmp alltraps
80106e77:	e9 91 f5 ff ff       	jmp    8010640d <alltraps>
...
80106e7c:	6a 00                	push   $0x0
  pushl $119
80106e7e:	6a 77                	push   $0x77
  jmp alltraps
80106e80:	e9 88 f5 ff ff       	jmp    8010640d <alltraps>
...
80106e8e:	6a 00                	push   $0x0
  pushl $121
80106e90:	6a 79                	push   $0x79
  jmp alltraps
80106e92:	e9 76 f5 ff ff       	jmp    8010640d <alltraps>
...
80106e97:	6a 00                	push   $0x0
  pushl $122
80106e99:	6a 7a                	push   $0x7a
  jmp alltraps
80106e9b:	e9 6d f5 ff ff       	jmp    8010640d <alltraps>
...
80106ea0:	6a 00                	push   $0x0
  pushl $123
80106ea2:	6a 7b                	push   $0x7b
  jmp alltraps
80106ea4:	e9 64 f5 ff ff       	jmp    8010640d <alltraps>
...
80106eb2:	6a 00                	push   $0x0
  pushl $125
80106eb4:	6a 7d                	push   $0x7d
  jmp alltraps
80106eb6:	e9 52 f5 ff ff       	jmp    8010640d <alltraps>
...
80106ebb:	6a 00                	push   $0x0
  pushl $126
80106ebd:	6a 7e                	push   $0x7e
  jmp alltraps
80106ebf:	e9 49 f5 ff ff       	jmp    8010640d <alltraps>
...
80106ec4:	6a 00                	push   $0x0
  pushl $127
80106ec6:	6a 7f                	push   $0x7f
  jmp alltraps
80106ec8:	e9 40 f5 ff ff       	jmp    8010640d <alltraps>
...
80106ecd:	6a 00                	push   $0x0
  pushl $128
80106ecf:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106ed4:	e9 34 f5 ff ff       	jmp    8010640d <alltraps>
...
80106ed9:	6a 00                	push   $0x0
  pushl $129
80106edb:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106ee0:	e9 28 f5 ff ff       	jmp    8010640d <alltraps>
...
80106ee5:	6a 00                	push   $0x0
  pushl $130
80106ee7:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106eec:	e9 1c f5 ff ff       	jmp    8010640d <alltraps>
...
80106ef1:	6a 00                	push   $0x0
  pushl $131
80106ef3:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106ef8:	e9 10 f5 ff ff       	jmp    8010640d <alltraps>
...
80106efd:	6a 00                	push   $0x0
  pushl $132
80106eff:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106f04:	e9 04 f5 ff ff       	jmp    8010640d <alltraps>
...
80106f09:	6a 00                	push   $0x0
  pushl $133
80106f0b:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106f10:	e9 f8 f4 ff ff       	jmp    8010640d <alltraps>
...
80106f15:	6a 00                	push   $0x0
  pushl $134
80106f17:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106f1c:	e9 ec f4 ff ff       	jmp    8010640d <alltraps>
...
80106f21:	6a 00                	push   $0x0
  pushl $135
80106f23:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106f28:	e9 e0 f4 ff ff       	jmp    8010640d <alltraps>
...
80106f2d:	6a 00                	push   $0x0
  pushl $136
80106f2f:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106f34:	e9 d4 f4 ff ff       	jmp    8010640d <alltraps>
...
80106f39:	6a 00                	push   $0x0
  pushl $137
80106f3b:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106f40:	e9 c8 f4 ff ff       	jmp    8010640d <alltraps>
...
80106f45:	6a 00                	push   $0x0
  pushl $138
80106f47:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106f4c:	e9 bc f4 ff ff       	jmp    8010640d <alltraps>
...
80106f51:	6a 00                	push   $0x0
  pushl $139
80106f53:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106f58:	e9 b0 f4 ff ff       	jmp    8010640d <alltraps>
...
80106f5d:	6a 00                	push   $0x0
  pushl $140
80106f5f:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106f64:	e9 a4 f4 ff ff       	jmp    8010640d <alltraps>
...
80106f69:	6a 00                	push   $0x0
  pushl $141
80106f6b:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106f70:	e9 98 f4 ff ff       	jmp    8010640d <alltraps>
...
80106f75:	6a 00                	push   $0x0
  pushl $142
80106f77:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106f7c:	e9 8c f4 ff ff       	jmp    8010640d <alltraps>
...
80106f81:	6a 00                	push   $0x0
  pushl $143
80106f83:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106f88:	e9 80 f4 ff ff       	jmp    8010640d <alltraps>
...
80106f8d:	6a 00                	push   $0x0
  pushl $144
80106f8f:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106f94:	e9 74 f4 ff ff       	jmp    8010640d <alltraps>
...
80106f99:	6a 00                	push   $0x0
  pushl $145
80106f9b:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106fa0:	e9 68 f4 ff ff       	jmp    8010640d <alltraps>
...
80106fa5:	6a 00                	push   $0x0
  pushl $146
80106fa7:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106fac:	e9 5c f4 ff ff       	jmp    8010640d <alltraps>
...
80106fb1:	6a 00                	push   $0x0
  pushl $147
80106fb3:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106fb8:	e9 50 f4 ff ff       	jmp    8010640d <alltraps>
...
80106fbd:	6a 00                	push   $0x0
  pushl $148
80106fbf:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106fc4:	e9 44 f4 ff ff       	jmp    8010640d <alltraps>
...
80106fc9:	6a 00                	push   $0x0
  pushl $149
80106fcb:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106fd0:	e9 38 f4 ff ff       	jmp    8010640d <alltraps>
...
80106fd5:	6a 00                	push   $0x0
  pushl $150
80106fd7:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106fdc:	e9 2c f4 ff ff       	jmp    8010640d <alltraps>
...
80106fe1:	6a 00                	push   $0x0
  pushl $151
80106fe3:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106fe8:	e9 20 f4 ff ff       	jmp    8010640d <alltraps>
...
80106fed:	6a 00                	push   $0x0
  pushl $152
80106fef:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106ff4:	e9 14 f4 ff ff       	jmp    8010640d <alltraps>
...
80106ff9:	6a 00                	push   $0x0
  pushl $153
80106ffb:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107000:	e9 08 f4 ff ff       	jmp    8010640d <alltraps>
...
80107005:	6a 00                	push   $0x0
  pushl $154
80107007:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010700c:	e9 fc f3 ff ff       	jmp    8010640d <alltraps>
...
80107011:	6a 00                	push   $0x0
  pushl $155
80107013:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107018:	e9 f0 f3 ff ff       	jmp    8010640d <alltraps>
...
8010701d:	6a 00                	push   $0x0
  pushl $156
8010701f:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107024:	e9 e4 f3 ff ff       	jmp    8010640d <alltraps>
...
80107029:	6a 00                	push   $0x0
  pushl $157
8010702b:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107030:	e9 d8 f3 ff ff       	jmp    8010640d <alltraps>
...
80107035:	6a 00                	push   $0x0
  pushl $158
80107037:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010703c:	e9 cc f3 ff ff       	jmp    8010640d <alltraps>
...
80107041:	6a 00                	push   $0x0
  pushl $159
80107043:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107048:	e9 c0 f3 ff ff       	jmp    8010640d <alltraps>
...
8010704d:	6a 00                	push   $0x0
  pushl $160
8010704f:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107054:	e9 b4 f3 ff ff       	jmp    8010640d <alltraps>
...
80107059:	6a 00                	push   $0x0
  pushl $161
8010705b:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107060:	e9 a8 f3 ff ff       	jmp    8010640d <alltraps>
...
80107065:	6a 00                	push   $0x0
  pushl $162
80107067:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010706c:	e9 9c f3 ff ff       	jmp    8010640d <alltraps>
...
80107071:	6a 00                	push   $0x0
  pushl $163
80107073:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107078:	e9 90 f3 ff ff       	jmp    8010640d <alltraps>
...
8010707d:	6a 00                	push   $0x0
  pushl $164
8010707f:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107084:	e9 84 f3 ff ff       	jmp    8010640d <alltraps>
...
80107089:	6a 00                	push   $0x0
  pushl $165
8010708b:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107090:	e9 78 f3 ff ff       	jmp    8010640d <alltraps>
...
80107095:	6a 00                	push   $0x0
  pushl $166
80107097:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010709c:	e9 6c f3 ff ff       	jmp    8010640d <alltraps>
...
801070a1:	6a 00                	push   $0x0
  pushl $167
801070a3:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801070a8:	e9 60 f3 ff ff       	jmp    8010640d <alltraps>
...
801070ad:	6a 00                	push   $0x0
  pushl $168
801070af:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801070b4:	e9 54 f3 ff ff       	jmp    8010640d <alltraps>
...
801070b9:	6a 00                	push   $0x0
  pushl $169
801070bb:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801070c0:	e9 48 f3 ff ff       	jmp    8010640d <alltraps>
...
801070c5:	6a 00                	push   $0x0
  pushl $170
801070c7:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801070cc:	e9 3c f3 ff ff       	jmp    8010640d <alltraps>
...
801070d1:	6a 00                	push   $0x0
  pushl $171
801070d3:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801070d8:	e9 30 f3 ff ff       	jmp    8010640d <alltraps>
...
801070dd:	6a 00                	push   $0x0
  pushl $172
801070df:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801070e4:	e9 24 f3 ff ff       	jmp    8010640d <alltraps>
...
801070e9:	6a 00                	push   $0x0
  pushl $173
801070eb:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801070f0:	e9 18 f3 ff ff       	jmp    8010640d <alltraps>
...
801070f5:	6a 00                	push   $0x0
  pushl $174
801070f7:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801070fc:	e9 0c f3 ff ff       	jmp    8010640d <alltraps>
...
80107101:	6a 00                	push   $0x0
  pushl $175
80107103:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107108:	e9 00 f3 ff ff       	jmp    8010640d <alltraps>
...
8010710d:	6a 00                	push   $0x0
  pushl $176
8010710f:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107114:	e9 f4 f2 ff ff       	jmp    8010640d <alltraps>
...
80107119:	6a 00                	push   $0x0
  pushl $177
8010711b:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107120:	e9 e8 f2 ff ff       	jmp    8010640d <alltraps>
...
80107125:	6a 00                	push   $0x0
  pushl $178
80107127:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010712c:	e9 dc f2 ff ff       	jmp    8010640d <alltraps>
...
80107131:	6a 00                	push   $0x0
  pushl $179
80107133:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107138:	e9 d0 f2 ff ff       	jmp    8010640d <alltraps>
...
8010713d:	6a 00                	push   $0x0
  pushl $180
8010713f:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107144:	e9 c4 f2 ff ff       	jmp    8010640d <alltraps>
...
80107149:	6a 00                	push   $0x0
  pushl $181
8010714b:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107150:	e9 b8 f2 ff ff       	jmp    8010640d <alltraps>
...
80107155:	6a 00                	push   $0x0
  pushl $182
80107157:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010715c:	e9 ac f2 ff ff       	jmp    8010640d <alltraps>
...
80107161:	6a 00                	push   $0x0
  pushl $183
80107163:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107168:	e9 a0 f2 ff ff       	jmp    8010640d <alltraps>
...
8010716d:	6a 00                	push   $0x0
  pushl $184
8010716f:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107174:	e9 94 f2 ff ff       	jmp    8010640d <alltraps>
...
80107179:	6a 00                	push   $0x0
  pushl $185
8010717b:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107180:	e9 88 f2 ff ff       	jmp    8010640d <alltraps>
...
80107185:	6a 00                	push   $0x0
  pushl $186
80107187:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010718c:	e9 7c f2 ff ff       	jmp    8010640d <alltraps>
...
80107191:	6a 00                	push   $0x0
  pushl $187
80107193:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107198:	e9 70 f2 ff ff       	jmp    8010640d <alltraps>
...
8010719d:	6a 00                	push   $0x0
  pushl $188
8010719f:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801071a4:	e9 64 f2 ff ff       	jmp    8010640d <alltraps>
...
801071a9:	6a 00                	push   $0x0
  pushl $189
801071ab:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801071b0:	e9 58 f2 ff ff       	jmp    8010640d <alltraps>
...
801071b5:	6a 00                	push   $0x0
  pushl $190
801071b7:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801071bc:	e9 4c f2 ff ff       	jmp    8010640d <alltraps>
...
801071c1:	6a 00                	push   $0x0
  pushl $191
801071c3:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801071c8:	e9 40 f2 ff ff       	jmp    8010640d <alltraps>
...
801071cd:	6a 00                	push   $0x0
  pushl $192
801071cf:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801071d4:	e9 34 f2 ff ff       	jmp    8010640d <alltraps>
...
801071d9:	6a 00                	push   $0x0
  pushl $193
801071db:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801071e0:	e9 28 f2 ff ff       	jmp    8010640d <alltraps>
...
801071e5:	6a 00                	push   $0x0
  pushl $194
801071e7:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801071ec:	e9 1c f2 ff ff       	jmp    8010640d <alltraps>
...
801071f1:	6a 00                	push   $0x0
  pushl $195
801071f3:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801071f8:	e9 10 f2 ff ff       	jmp    8010640d <alltraps>
...
801071fd:	6a 00                	push   $0x0
  pushl $196
801071ff:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107204:	e9 04 f2 ff ff       	jmp    8010640d <alltraps>
...
80107209:	6a 00                	push   $0x0
  pushl $197
8010720b:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107210:	e9 f8 f1 ff ff       	jmp    8010640d <alltraps>
...
80107215:	6a 00                	push   $0x0
  pushl $198
80107217:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010721c:	e9 ec f1 ff ff       	jmp    8010640d <alltraps>
...
80107221:	6a 00                	push   $0x0
  pushl $199
80107223:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107228:	e9 e0 f1 ff ff       	jmp    8010640d <alltraps>
...
8010722d:	6a 00                	push   $0x0
  pushl $200
8010722f:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107234:	e9 d4 f1 ff ff       	jmp    8010640d <alltraps>
...
80107239:	6a 00                	push   $0x0
  pushl $201
8010723b:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107240:	e9 c8 f1 ff ff       	jmp    8010640d <alltraps>
...
80107245:	6a 00                	push   $0x0
  pushl $202
80107247:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010724c:	e9 bc f1 ff ff       	jmp    8010640d <alltraps>
...
80107251:	6a 00                	push   $0x0
  pushl $203
80107253:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107258:	e9 b0 f1 ff ff       	jmp    8010640d <alltraps>
...
8010725d:	6a 00                	push   $0x0
  pushl $204
8010725f:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107264:	e9 a4 f1 ff ff       	jmp    8010640d <alltraps>
...
80107269:	6a 00                	push   $0x0
  pushl $205
8010726b:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107270:	e9 98 f1 ff ff       	jmp    8010640d <alltraps>
...
80107275:	6a 00                	push   $0x0
  pushl $206
80107277:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010727c:	e9 8c f1 ff ff       	jmp    8010640d <alltraps>
...
80107281:	6a 00                	push   $0x0
  pushl $207
80107283:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107288:	e9 80 f1 ff ff       	jmp    8010640d <alltraps>
...
8010728d:	6a 00                	push   $0x0
  pushl $208
8010728f:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107294:	e9 74 f1 ff ff       	jmp    8010640d <alltraps>
...
80107299:	6a 00                	push   $0x0
  pushl $209
8010729b:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801072a0:	e9 68 f1 ff ff       	jmp    8010640d <alltraps>
...
801072a5:	6a 00                	push   $0x0
  pushl $210
801072a7:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801072ac:	e9 5c f1 ff ff       	jmp    8010640d <alltraps>
...
801072b1:	6a 00                	push   $0x0
  pushl $211
801072b3:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801072b8:	e9 50 f1 ff ff       	jmp    8010640d <alltraps>
...
801072bd:	6a 00                	push   $0x0
  pushl $212
801072bf:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801072c4:	e9 44 f1 ff ff       	jmp    8010640d <alltraps>
...
801072c9:	6a 00                	push   $0x0
  pushl $213
801072cb:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801072d0:	e9 38 f1 ff ff       	jmp    8010640d <alltraps>
...
801072d5:	6a 00                	push   $0x0
  pushl $214
801072d7:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801072dc:	e9 2c f1 ff ff       	jmp    8010640d <alltraps>
...
801072e1:	6a 00                	push   $0x0
  pushl $215
801072e3:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801072e8:	e9 20 f1 ff ff       	jmp    8010640d <alltraps>
...
801072ed:	6a 00                	push   $0x0
  pushl $216
801072ef:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801072f4:	e9 14 f1 ff ff       	jmp    8010640d <alltraps>
...
801072f9:	6a 00                	push   $0x0
  pushl $217
801072fb:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107300:	e9 08 f1 ff ff       	jmp    8010640d <alltraps>
...
80107305:	6a 00                	push   $0x0
  pushl $218
80107307:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010730c:	e9 fc f0 ff ff       	jmp    8010640d <alltraps>
...
80107311:	6a 00                	push   $0x0
  pushl $219
80107313:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107318:	e9 f0 f0 ff ff       	jmp    8010640d <alltraps>
...
8010731d:	6a 00                	push   $0x0
  pushl $220
8010731f:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107324:	e9 e4 f0 ff ff       	jmp    8010640d <alltraps>
...
80107329:	6a 00                	push   $0x0
  pushl $221
8010732b:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107330:	e9 d8 f0 ff ff       	jmp    8010640d <alltraps>
...
80107335:	6a 00                	push   $0x0
  pushl $222
80107337:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010733c:	e9 cc f0 ff ff       	jmp    8010640d <alltraps>
...
80107341:	6a 00                	push   $0x0
  pushl $223
80107343:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107348:	e9 c0 f0 ff ff       	jmp    8010640d <alltraps>
...
8010734d:	6a 00                	push   $0x0
  pushl $224
8010734f:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107354:	e9 b4 f0 ff ff       	jmp    8010640d <alltraps>
...
80107359:	6a 00                	push   $0x0
  pushl $225
8010735b:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107360:	e9 a8 f0 ff ff       	jmp    8010640d <alltraps>
...
80107365:	6a 00                	push   $0x0
  pushl $226
80107367:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010736c:	e9 9c f0 ff ff       	jmp    8010640d <alltraps>
...
80107371:	6a 00                	push   $0x0
  pushl $227
80107373:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107378:	e9 90 f0 ff ff       	jmp    8010640d <alltraps>
...
8010737d:	6a 00                	push   $0x0
  pushl $228
8010737f:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107384:	e9 84 f0 ff ff       	jmp    8010640d <alltraps>
...
80107389:	6a 00                	push   $0x0
  pushl $229
8010738b:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107390:	e9 78 f0 ff ff       	jmp    8010640d <alltraps>
...
80107395:	6a 00                	push   $0x0
  pushl $230
80107397:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010739c:	e9 6c f0 ff ff       	jmp    8010640d <alltraps>
...
801073a1:	6a 00                	push   $0x0
  pushl $231
801073a3:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801073a8:	e9 60 f0 ff ff       	jmp    8010640d <alltraps>
...
801073ad:	6a 00                	push   $0x0
  pushl $232
801073af:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801073b4:	e9 54 f0 ff ff       	jmp    8010640d <alltraps>
...
801073b9:	6a 00                	push   $0x0
  pushl $233
801073bb:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801073c0:	e9 48 f0 ff ff       	jmp    8010640d <alltraps>
...
801073c5:	6a 00                	push   $0x0
  pushl $234
801073c7:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801073cc:	e9 3c f0 ff ff       	jmp    8010640d <alltraps>
...
801073d1:	6a 00                	push   $0x0
  pushl $235
801073d3:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801073d8:	e9 30 f0 ff ff       	jmp    8010640d <alltraps>
...
801073dd:	6a 00                	push   $0x0
  pushl $236
801073df:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801073e4:	e9 24 f0 ff ff       	jmp    8010640d <alltraps>
...
801073e9:	6a 00                	push   $0x0
  pushl $237
801073eb:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801073f0:	e9 18 f0 ff ff       	jmp    8010640d <alltraps>
...
801073f5:	6a 00                	push   $0x0
  pushl $238
801073f7:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801073fc:	e9 0c f0 ff ff       	jmp    8010640d <alltraps>
...
80107401:	6a 00                	push   $0x0
  pushl $239
80107403:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107408:	e9 00 f0 ff ff       	jmp    8010640d <alltraps>
...
8010740d:	6a 00                	push   $0x0
  pushl $240
8010740f:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107414:	e9 f4 ef ff ff       	jmp    8010640d <alltraps>
...
80107419:	6a 00                	push   $0x0
  pushl $241
8010741b:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107420:	e9 e8 ef ff ff       	jmp    8010640d <alltraps>
...
80107425:	6a 00                	push   $0x0
  pushl $242
80107427:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010742c:	e9 dc ef ff ff       	jmp    8010640d <alltraps>
...
80107431:	6a 00                	push   $0x0
  pushl $243
80107433:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107438:	e9 d0 ef ff ff       	jmp    8010640d <alltraps>
...
8010743d:	6a 00                	push   $0x0
  pushl $244
8010743f:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107444:	e9 c4 ef ff ff       	jmp    8010640d <alltraps>
...
80107449:	6a 00                	push   $0x0
  pushl $245
8010744b:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107450:	e9 b8 ef ff ff       	jmp    8010640d <alltraps>
...
80107455:	6a 00                	push   $0x0
  pushl $246
80107457:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010745c:	e9 ac ef ff ff       	jmp    8010640d <alltraps>
...
80107461:	6a 00                	push   $0x0
  pushl $247
80107463:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107468:	e9 a0 ef ff ff       	jmp    8010640d <alltraps>
...
8010746d:	6a 00                	push   $0x0
  pushl $248
8010746f:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107474:	e9 94 ef ff ff       	jmp    8010640d <alltraps>
...
80107479:	6a 00                	push   $0x0
  pushl $249
8010747b:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107480:	e9 88 ef ff ff       	jmp    8010640d <alltraps>
...
80107485:	6a 00                	push   $0x0
  pushl $250
80107487:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010748c:	e9 7c ef ff ff       	jmp    8010640d <alltraps>
...
80107491:	6a 00                	push   $0x0
  pushl $251
80107493:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107498:	e9 70 ef ff ff       	jmp    8010640d <alltraps>
...
8010749d:	6a 00                	push   $0x0
  pushl $252
8010749f:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801074a4:	e9 64 ef ff ff       	jmp    8010640d <alltraps>
...
801074a9:	6a 00                	push   $0x0
  pushl $253
801074ab:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801074b0:	e9 58 ef ff ff       	jmp    8010640d <alltraps>
...
801074b5:	6a 00                	push   $0x0
  pushl $254
801074b7:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801074bc:	e9 4c ef ff ff       	jmp    8010640d <alltraps>
...
801074c1:	6a 00                	push   $0x0
  pushl $255
801074c3:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801074c8:	e9 40 ef ff ff       	jmp    8010640d <alltraps>

801074cd <lgdt>:
{
801074cd:	55                   	push   %ebp
801074ce:	89 e5                	mov    %esp,%ebp
801074d0:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
801074d3:	8b 45 0c             	mov    0xc(%ebp),%eax
801074d6:	83 e8 01             	sub    $0x1,%eax
801074d9:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801074dd:	8b 45 08             	mov    0x8(%ebp),%eax
801074e0:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801074e4:	8b 45 08             	mov    0x8(%ebp),%eax
801074e7:	c1 e8 10             	shr    $0x10,%eax
801074ea:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
801074ee:	8d 45 fa             	lea    -0x6(%ebp),%eax
801074f1:	0f 01 10             	lgdtl  (%eax)
}
801074f4:	c9                   	leave  
801074f5:	c3                   	ret    
...
801074ff:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107503:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107507:	0f 00 d8             	ltr    %ax
}
8010750a:	c9                   	leave  
8010750b:	c3                   	ret    
...
8010751a:	83 ec 28             	sub    $0x28,%esp
  ...
  c = &cpus[cpuid()];
8010751d:	e8 a8 cb ff ff       	call   801040ca <cpuid>
80107522:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80107528:	05 00 38 11 80       	add    $0x80113800,%eax
8010752d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107530:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107533:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107539:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010753c:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107542:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107545:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107549:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010754c:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107550:	83 e2 f0             	and    $0xfffffff0,%edx
80107553:	83 ca 0a             	or     $0xa,%edx
80107556:	88 50 7d             	mov    %dl,0x7d(%eax)
80107559:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010755c:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107560:	83 ca 10             	or     $0x10,%edx
80107563:	88 50 7d             	mov    %dl,0x7d(%eax)
80107566:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107569:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
8010756d:	83 e2 9f             	and    $0xffffff9f,%edx
80107570:	88 50 7d             	mov    %dl,0x7d(%eax)
80107573:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107576:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
8010757a:	83 ca 80             	or     $0xffffff80,%edx
8010757d:	88 50 7d             	mov    %dl,0x7d(%eax)
80107580:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107583:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107587:	83 ca 0f             	or     $0xf,%edx
8010758a:	88 50 7e             	mov    %dl,0x7e(%eax)
8010758d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107590:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107594:	83 e2 ef             	and    $0xffffffef,%edx
80107597:	88 50 7e             	mov    %dl,0x7e(%eax)
8010759a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010759d:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801075a1:	83 e2 df             	and    $0xffffffdf,%edx
801075a4:	88 50 7e             	mov    %dl,0x7e(%eax)
801075a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075aa:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801075ae:	83 ca 40             	or     $0x40,%edx
801075b1:	88 50 7e             	mov    %dl,0x7e(%eax)
801075b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075b7:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801075bb:	83 ca 80             	or     $0xffffff80,%edx
801075be:	88 50 7e             	mov    %dl,0x7e(%eax)
801075c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075c4:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801075c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075cb:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
801075d2:	ff ff 
801075d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075d7:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
801075de:	00 00 
801075e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075e3:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
801075ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075ed:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801075f4:	83 e2 f0             	and    $0xfffffff0,%edx
801075f7:	83 ca 02             	or     $0x2,%edx
801075fa:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107600:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107603:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010760a:	83 ca 10             	or     $0x10,%edx
8010760d:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107613:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107616:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010761d:	83 e2 9f             	and    $0xffffff9f,%edx
80107620:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107626:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107629:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107630:	83 ca 80             	or     $0xffffff80,%edx
80107633:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
...
8010764f:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107656:	83 e2 ef             	and    $0xffffffef,%edx
80107659:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010765f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107662:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107669:	83 e2 df             	and    $0xffffffdf,%edx
8010766c:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107672:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107675:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010767c:	83 ca 40             	or     $0x40,%edx
8010767f:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107685:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107688:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010768f:	83 ca 80             	or     $0xffffff80,%edx
80107692:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107698:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010769b:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801076a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076a5:	66 c7 80 88 00 00 00 	movw   $0xffff,0x88(%eax)
801076ac:	ff ff 
801076ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076b1:	66 c7 80 8a 00 00 00 	movw   $0x0,0x8a(%eax)
801076b8:	00 00 
801076ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076bd:	c6 80 8c 00 00 00 00 	movb   $0x0,0x8c(%eax)
801076c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076c7:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801076ce:	83 e2 f0             	and    $0xfffffff0,%edx
801076d1:	83 ca 0a             	or     $0xa,%edx
801076d4:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801076da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076dd:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801076e4:	83 ca 10             	or     $0x10,%edx
801076e7:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801076ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076f0:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801076f7:	83 ca 60             	or     $0x60,%edx
801076fa:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
80107700:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107703:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
8010770a:	83 ca 80             	or     $0xffffff80,%edx
8010770d:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
80107713:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107716:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
8010771d:	83 ca 0f             	or     $0xf,%edx
80107720:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107726:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107729:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107730:	83 e2 ef             	and    $0xffffffef,%edx
80107733:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107739:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010773c:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107743:	83 e2 df             	and    $0xffffffdf,%edx
80107746:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
8010774c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010774f:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107756:	83 ca 40             	or     $0x40,%edx
80107759:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
8010775f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107762:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107769:	83 ca 80             	or     $0xffffff80,%edx
8010776c:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107772:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107775:	c6 80 8f 00 00 00 00 	movb   $0x0,0x8f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010777c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010777f:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107786:	ff ff 
80107788:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010778b:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107792:	00 00 
80107794:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107797:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
8010779e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077a1:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801077a8:	83 e2 f0             	and    $0xfffffff0,%edx
801077ab:	83 ca 02             	or     $0x2,%edx
801077ae:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801077b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077b7:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801077be:	83 ca 10             	or     $0x10,%edx
801077c1:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801077c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ca:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801077d1:	83 ca 60             	or     $0x60,%edx
801077d4:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801077da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077dd:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801077e4:	83 ca 80             	or     $0xffffff80,%edx
801077e7:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801077ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077f0:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801077f7:	83 ca 0f             	or     $0xf,%edx
801077fa:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107800:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107803:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010780a:	83 e2 ef             	and    $0xffffffef,%edx
8010780d:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107813:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107816:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010781d:	83 e2 df             	and    $0xffffffdf,%edx
80107820:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107826:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107829:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107830:	83 ca 40             	or     $0x40,%edx
80107833:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107839:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010783c:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107843:	83 ca 80             	or     $0xffffff80,%edx
80107846:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
8010784c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010784f:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80107856:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107859:	83 c0 70             	add    $0x70,%eax
8010785c:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
80107863:	00 
80107864:	89 04 24             	mov    %eax,(%esp)
80107867:	e8 61 fc ff ff       	call   801074cd <lgdt>
}
8010786c:	c9                   	leave  
8010786d:	c3                   	ret    
...
80107871:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107874:	8b 45 0c             	mov    0xc(%ebp),%eax
80107877:	c1 e8 16             	shr    $0x16,%eax
8010787a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107881:	8b 45 08             	mov    0x8(%ebp),%eax
80107884:	01 d0                	add    %edx,%eax
80107886:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107889:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010788c:	8b 00                	mov    (%eax),%eax
8010788e:	83 e0 01             	and    $0x1,%eax
80107891:	85 c0                	test   %eax,%eax
80107893:	74 14                	je     801078a9 <walkpgdir+0x3b>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107895:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107898:	8b 00                	mov    (%eax),%eax
8010789a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010789f:	05 00 00 00 80       	add    $0x80000000,%eax
801078a4:	89 45 f4             	mov    %eax,-0xc(%ebp)
801078a7:	eb 48                	jmp    801078f1 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801078a9:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801078ad:	74 0e                	je     801078bd <walkpgdir+0x4f>
801078af:	e8 f5 b2 ff ff       	call   80102ba9 <kalloc>
801078b4:	89 45 f4             	mov    %eax,-0xc(%ebp)
801078b7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801078bb:	75 07                	jne    801078c4 <walkpgdir+0x56>
      return 0;
801078bd:	b8 00 00 00 00       	mov    $0x0,%eax
801078c2:	eb 44                	jmp    80107908 <walkpgdir+0x9a>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
801078c4:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801078cb:	00 
801078cc:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801078d3:	00 
801078d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078d7:	89 04 24             	mov    %eax,(%esp)
801078da:	e8 2b d7 ff ff       	call   8010500a <memset>
...
801078e7:	83 c8 07             	or     $0x7,%eax
801078ea:	89 c2                	mov    %eax,%edx
801078ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801078ef:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
801078f1:	8b 45 0c             	mov    0xc(%ebp),%eax
801078f4:	c1 e8 0c             	shr    $0xc,%eax
801078f7:	25 ff 03 00 00       	and    $0x3ff,%eax
801078fc:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107903:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107906:	01 d0                	add    %edx,%eax
}
80107908:	c9                   	leave  
80107909:	c3                   	ret    
...
8010790d:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
80107918:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010791b:	8b 55 0c             	mov    0xc(%ebp),%edx
8010791e:	8b 45 10             	mov    0x10(%ebp),%eax
80107921:	01 d0                	add    %edx,%eax
80107923:	83 e8 01             	sub    $0x1,%eax
80107926:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010792b:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010792e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107935:	00 
80107936:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107939:	89 44 24 04          	mov    %eax,0x4(%esp)
8010793d:	8b 45 08             	mov    0x8(%ebp),%eax
80107940:	89 04 24             	mov    %eax,(%esp)
80107943:	e8 26 ff ff ff       	call   8010786e <walkpgdir>
80107948:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010794b:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010794f:	75 07                	jne    80107958 <mappages+0x4e>
      return -1;
80107951:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107956:	eb 48                	jmp    801079a0 <mappages+0x96>
    if(*pte & PTE_P)
80107958:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010795b:	8b 00                	mov    (%eax),%eax
8010795d:	83 e0 01             	and    $0x1,%eax
80107960:	85 c0                	test   %eax,%eax
80107962:	74 0c                	je     80107970 <mappages+0x66>
      panic("remap");
80107964:	c7 04 24 90 88 10 80 	movl   $0x80108890,(%esp)
8010796b:	e8 f2 8b ff ff       	call   80100562 <panic>
    *pte = pa | perm | PTE_P;
80107970:	8b 45 18             	mov    0x18(%ebp),%eax
80107973:	0b 45 14             	or     0x14(%ebp),%eax
80107976:	83 c8 01             	or     $0x1,%eax
80107979:	89 c2                	mov    %eax,%edx
8010797b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010797e:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107980:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107983:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107986:	75 08                	jne    80107990 <mappages+0x86>
      break;
80107988:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
801079a6:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
801079a9:	e8 fb b1 ff ff       	call   80102ba9 <kalloc>
801079ae:	89 45 f0             	mov    %eax,-0x10(%ebp)
801079b1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801079b5:	75 0a                	jne    801079c1 <setupkvm+0x1f>
    return 0;
801079b7:	b8 00 00 00 00       	mov    $0x0,%eax
801079bc:	e9 84 00 00 00       	jmp    80107a45 <setupkvm+0xa3>
  memset(pgdir, 0, PGSIZE);
801079c1:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801079c8:	00 
801079c9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801079d0:	00 
801079d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801079d4:	89 04 24             	mov    %eax,(%esp)
801079d7:	e8 2e d6 ff ff       	call   8010500a <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801079dc:	c7 45 f4 80 b4 10 80 	movl   $0x8010b480,-0xc(%ebp)
801079e3:	eb 54                	jmp    80107a39 <setupkvm+0x97>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801079e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079e8:	8b 48 0c             	mov    0xc(%eax),%ecx
801079eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079ee:	8b 50 04             	mov    0x4(%eax),%edx
801079f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079f4:	8b 58 08             	mov    0x8(%eax),%ebx
801079f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079fa:	8b 40 04             	mov    0x4(%eax),%eax
801079fd:	29 c3                	sub    %eax,%ebx
801079ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a02:	8b 00                	mov    (%eax),%eax
80107a04:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107a08:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107a0c:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107a10:	89 44 24 04          	mov    %eax,0x4(%esp)
80107a14:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a17:	89 04 24             	mov    %eax,(%esp)
80107a1a:	e8 eb fe ff ff       	call   8010790a <mappages>
80107a1f:	85 c0                	test   %eax,%eax
80107a21:	79 12                	jns    80107a35 <setupkvm+0x93>
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80107a23:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a26:	89 04 24             	mov    %eax,(%esp)
80107a29:	e8 26 05 00 00       	call   80107f54 <freevm>
      return 0;
80107a2e:	b8 00 00 00 00       	mov    $0x0,%eax
80107a33:	eb 10                	jmp    80107a45 <setupkvm+0xa3>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107a35:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107a39:	81 7d f4 c0 b4 10 80 	cmpl   $0x8010b4c0,-0xc(%ebp)
80107a40:	72 a3                	jb     801079e5 <setupkvm+0x43>
    }
  return pgdir;
80107a42:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80107a45:	83 c4 34             	add    $0x34,%esp
80107a48:	5b                   	pop    %ebx
80107a49:	5d                   	pop    %ebp
80107a4a:	c3                   	ret    
...
80107a4e:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107a51:	e8 4c ff ff ff       	call   801079a2 <setupkvm>
80107a56:	a3 24 65 11 80       	mov    %eax,0x80116524
  switchkvm();
80107a5b:	e8 02 00 00 00       	call   80107a62 <switchkvm>
}
80107a60:	c9                   	leave  
80107a61:	c3                   	ret    
...
80107a65:	83 ec 04             	sub    $0x4,%esp
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80107a68:	a1 24 65 11 80       	mov    0x80116524,%eax
80107a6d:	05 00 00 00 80       	add    $0x80000000,%eax
80107a72:	89 04 24             	mov    %eax,(%esp)
80107a75:	e8 92 fa ff ff       	call   8010750c <lcr3>
}
80107a7a:	c9                   	leave  
80107a7b:	c3                   	ret    
...
80107a7f:	57                   	push   %edi
80107a80:	56                   	push   %esi
80107a81:	53                   	push   %ebx
80107a82:	83 ec 1c             	sub    $0x1c,%esp
  if(p == 0)
80107a85:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107a89:	75 0c                	jne    80107a97 <switchuvm+0x1b>
    panic("switchuvm: no process");
80107a8b:	c7 04 24 96 88 10 80 	movl   $0x80108896,(%esp)
80107a92:	e8 cb 8a ff ff       	call   80100562 <panic>
  if(p->kstack == 0)
80107a97:	8b 45 08             	mov    0x8(%ebp),%eax
80107a9a:	8b 40 08             	mov    0x8(%eax),%eax
80107a9d:	85 c0                	test   %eax,%eax
80107a9f:	75 0c                	jne    80107aad <switchuvm+0x31>
    panic("switchuvm: no kstack");
80107aa1:	c7 04 24 ac 88 10 80 	movl   $0x801088ac,(%esp)
80107aa8:	e8 b5 8a ff ff       	call   80100562 <panic>
  if(p->pgdir == 0)
80107aad:	8b 45 08             	mov    0x8(%ebp),%eax
80107ab0:	8b 40 04             	mov    0x4(%eax),%eax
80107ab3:	85 c0                	test   %eax,%eax
80107ab5:	75 0c                	jne    80107ac3 <switchuvm+0x47>
    panic("switchuvm: no pgdir");
80107ab7:	c7 04 24 c1 88 10 80 	movl   $0x801088c1,(%esp)
80107abe:	e8 9f 8a ff ff       	call   80100562 <panic>

  pushcli();
80107ac3:	e8 3d d4 ff ff       	call   80104f05 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80107ac8:	e8 1e c6 ff ff       	call   801040eb <mycpu>
80107acd:	89 c3                	mov    %eax,%ebx
80107acf:	e8 17 c6 ff ff       	call   801040eb <mycpu>
80107ad4:	83 c0 08             	add    $0x8,%eax
80107ad7:	89 c7                	mov    %eax,%edi
80107ad9:	e8 0d c6 ff ff       	call   801040eb <mycpu>
80107ade:	83 c0 08             	add    $0x8,%eax
80107ae1:	c1 e8 10             	shr    $0x10,%eax
80107ae4:	89 c6                	mov    %eax,%esi
80107ae6:	e8 00 c6 ff ff       	call   801040eb <mycpu>
80107aeb:	83 c0 08             	add    $0x8,%eax
80107aee:	c1 e8 18             	shr    $0x18,%eax
80107af1:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80107af8:	67 00 
80107afa:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80107b01:	89 f1                	mov    %esi,%ecx
80107b03:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107b09:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107b10:	83 e2 f0             	and    $0xfffffff0,%edx
80107b13:	83 ca 09             	or     $0x9,%edx
80107b16:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107b1c:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107b23:	83 ca 10             	or     $0x10,%edx
80107b26:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107b2c:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107b33:	83 e2 9f             	and    $0xffffff9f,%edx
80107b36:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107b3c:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107b43:	83 ca 80             	or     $0xffffff80,%edx
80107b46:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107b4c:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b53:	83 e2 f0             	and    $0xfffffff0,%edx
80107b56:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b5c:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b63:	83 e2 ef             	and    $0xffffffef,%edx
80107b66:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b6c:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b73:	83 e2 df             	and    $0xffffffdf,%edx
80107b76:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b7c:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b83:	83 ca 40             	or     $0x40,%edx
80107b86:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b8c:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b93:	83 e2 7f             	and    $0x7f,%edx
80107b96:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b9c:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80107ba2:	e8 44 c5 ff ff       	call   801040eb <mycpu>
80107ba7:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107bae:	83 e2 ef             	and    $0xffffffef,%edx
80107bb1:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80107bb7:	e8 2f c5 ff ff       	call   801040eb <mycpu>
80107bbc:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107bc2:	e8 24 c5 ff ff       	call   801040eb <mycpu>
80107bc7:	8b 55 08             	mov    0x8(%ebp),%edx
80107bca:	8b 52 08             	mov    0x8(%edx),%edx
80107bcd:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107bd3:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107bd6:	e8 10 c5 ff ff       	call   801040eb <mycpu>
80107bdb:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  ltr(SEG_TSS << 3);
80107be1:	c7 04 24 28 00 00 00 	movl   $0x28,(%esp)
80107be8:	e8 09 f9 ff ff       	call   801074f6 <ltr>
  lcr3(V2P(p->pgdir));  // switch to process's address space
80107bed:	8b 45 08             	mov    0x8(%ebp),%eax
80107bf0:	8b 40 04             	mov    0x4(%eax),%eax
80107bf3:	05 00 00 00 80       	add    $0x80000000,%eax
80107bf8:	89 04 24             	mov    %eax,(%esp)
80107bfb:	e8 0c f9 ff ff       	call   8010750c <lcr3>
  popcli();
80107c00:	e8 4c d3 ff ff       	call   80104f51 <popcli>
}
80107c05:	83 c4 1c             	add    $0x1c,%esp
80107c08:	5b                   	pop    %ebx
80107c09:	5e                   	pop    %esi
80107c0a:	5f                   	pop    %edi
80107c0b:	5d                   	pop    %ebp
...
80107c10:	83 ec 38             	sub    $0x38,%esp
  char *mem;

  if(sz >= PGSIZE)
80107c13:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107c1a:	76 0c                	jbe    80107c28 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107c1c:	c7 04 24 d5 88 10 80 	movl   $0x801088d5,(%esp)
80107c23:	e8 3a 89 ff ff       	call   80100562 <panic>
  mem = kalloc();
80107c28:	e8 7c af ff ff       	call   80102ba9 <kalloc>
...
80107c46:	e8 bf d3 ff ff       	call   8010500a <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80107c4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c4e:	05 00 00 00 80       	add    $0x80000000,%eax
80107c53:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107c5a:	00 
80107c5b:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107c5f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107c66:	00 
80107c67:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107c6e:	00 
80107c6f:	8b 45 08             	mov    0x8(%ebp),%eax
80107c72:	89 04 24             	mov    %eax,(%esp)
80107c75:	e8 90 fc ff ff       	call   8010790a <mappages>
  memmove(mem, init, sz);
80107c7a:	8b 45 10             	mov    0x10(%ebp),%eax
80107c7d:	89 44 24 08          	mov    %eax,0x8(%esp)
80107c81:	8b 45 0c             	mov    0xc(%ebp),%eax
80107c84:	89 44 24 04          	mov    %eax,0x4(%esp)
80107c88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c8b:	89 04 24             	mov    %eax,(%esp)
80107c8e:	e8 46 d4 ff ff       	call   801050d9 <memmove>
}
80107c93:	c9                   	leave  
80107c94:	c3                   	ret    
...
80107c98:	83 ec 28             	sub    $0x28,%esp
  uint i, pa, n;
  pte_t *pte;
...
80107ca5:	74 0c                	je     80107cb3 <loaduvm+0x1e>
    panic("loaduvm: addr must be page aligned");
80107ca7:	c7 04 24 f0 88 10 80 	movl   $0x801088f0,(%esp)
80107cae:	e8 af 88 ff ff       	call   80100562 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107cb3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107cba:	e9 a6 00 00 00       	jmp    80107d65 <loaduvm+0xd0>
...
80107cd9:	e8 90 fb ff ff       	call   8010786e <walkpgdir>
80107cde:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107ce1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107ce5:	75 0c                	jne    80107cf3 <loaduvm+0x5e>
      panic("loaduvm: address should exist");
80107ce7:	c7 04 24 13 89 10 80 	movl   $0x80108913,(%esp)
80107cee:	e8 6f 88 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
...
80107d0a:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107d0f:	77 0f                	ja     80107d20 <loaduvm+0x8b>
      n = sz - i;
80107d11:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d14:	8b 55 18             	mov    0x18(%ebp),%edx
80107d17:	29 c2                	sub    %eax,%edx
80107d19:	89 d0                	mov    %edx,%eax
80107d1b:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107d1e:	eb 07                	jmp    80107d27 <loaduvm+0x92>
    else
      n = PGSIZE;
80107d20:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107d27:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d2a:	8b 55 14             	mov    0x14(%ebp),%edx
80107d2d:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80107d30:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107d33:	05 00 00 00 80       	add    $0x80000000,%eax
80107d38:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107d3b:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107d3f:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107d43:	89 44 24 04          	mov    %eax,0x4(%esp)
80107d47:	8b 45 10             	mov    0x10(%ebp),%eax
80107d4a:	89 04 24             	mov    %eax,(%esp)
80107d4d:	e8 a8 a0 ff ff       	call   80101dfa <readi>
80107d52:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107d55:	74 07                	je     80107d5e <loaduvm+0xc9>
      return -1;
80107d57:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107d5c:	eb 18                	jmp    80107d76 <loaduvm+0xe1>
  for(i = 0; i < sz; i += PGSIZE){
80107d5e:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107d65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d68:	3b 45 18             	cmp    0x18(%ebp),%eax
80107d6b:	0f 82 4e ff ff ff    	jb     80107cbf <loaduvm+0x2a>
  }
  return 0;
...
80107d7b:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107d83:	79 0a                	jns    80107d8f <allocuvm+0x17>
    return 0;
80107d85:	b8 00 00 00 00       	mov    $0x0,%eax
80107d8a:	e9 fd 00 00 00       	jmp    80107e8c <allocuvm+0x114>
  if(newsz < oldsz)
80107d8f:	8b 45 10             	mov    0x10(%ebp),%eax
80107d92:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107d95:	73 08                	jae    80107d9f <allocuvm+0x27>
    return oldsz;
80107d97:	8b 45 0c             	mov    0xc(%ebp),%eax
80107d9a:	e9 ed 00 00 00       	jmp    80107e8c <allocuvm+0x114>

  a = PGROUNDUP(oldsz);
80107d9f:	8b 45 0c             	mov    0xc(%ebp),%eax
80107da2:	05 ff 0f 00 00       	add    $0xfff,%eax
80107da7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107dac:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80107daf:	e9 c9 00 00 00       	jmp    80107e7d <allocuvm+0x105>
    mem = kalloc();
80107db4:	e8 f0 ad ff ff       	call   80102ba9 <kalloc>
80107db9:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107dbc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107dc0:	75 2f                	jne    80107df1 <allocuvm+0x79>
      cprintf("allocuvm out of memory\n");
80107dc2:	c7 04 24 31 89 10 80 	movl   $0x80108931,(%esp)
80107dc9:	e8 fa 85 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107dce:	8b 45 0c             	mov    0xc(%ebp),%eax
80107dd1:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107de2:	e8 a7 00 00 00       	call   80107e8e <deallocuvm>
      return 0;
80107de7:	b8 00 00 00 00       	mov    $0x0,%eax
80107dec:	e9 9b 00 00 00       	jmp    80107e8c <allocuvm+0x114>
    }
    memset(mem, 0, PGSIZE);
80107df1:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107df8:	00 
80107df9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107e00:	00 
80107e01:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e04:	89 04 24             	mov    %eax,(%esp)
80107e07:	e8 fe d1 ff ff       	call   8010500a <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80107e0c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e0f:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
80107e15:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e18:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107e1f:	00 
80107e20:	89 54 24 0c          	mov    %edx,0xc(%esp)
...
80107e36:	e8 cf fa ff ff       	call   8010790a <mappages>
80107e3b:	85 c0                	test   %eax,%eax
80107e3d:	79 37                	jns    80107e76 <allocuvm+0xfe>
      cprintf("allocuvm out of memory (2)\n");
80107e3f:	c7 04 24 49 89 10 80 	movl   $0x80108949,(%esp)
80107e46:	e8 7d 85 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107e4b:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e4e:	89 44 24 08          	mov    %eax,0x8(%esp)
80107e52:	8b 45 10             	mov    0x10(%ebp),%eax
80107e55:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e59:	8b 45 08             	mov    0x8(%ebp),%eax
80107e5c:	89 04 24             	mov    %eax,(%esp)
80107e5f:	e8 2a 00 00 00       	call   80107e8e <deallocuvm>
      kfree(mem);
80107e64:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e67:	89 04 24             	mov    %eax,(%esp)
80107e6a:	e8 a4 ac ff ff       	call   80102b13 <kfree>
      return 0;
80107e6f:	b8 00 00 00 00       	mov    $0x0,%eax
80107e74:	eb 16                	jmp    80107e8c <allocuvm+0x114>
  for(; a < newsz; a += PGSIZE){
80107e76:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107e7d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e80:	3b 45 10             	cmp    0x10(%ebp),%eax
80107e83:	0f 82 2b ff ff ff    	jb     80107db4 <allocuvm+0x3c>
    }
  }
  return newsz;
...
{
80107e8e:	55                   	push   %ebp
80107e8f:	89 e5                	mov    %esp,%ebp
80107e91:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
80107e9a:	72 08                	jb     80107ea4 <deallocuvm+0x16>
    return oldsz;
80107e9c:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e9f:	e9 ae 00 00 00       	jmp    80107f52 <deallocuvm+0xc4>

  a = PGROUNDUP(newsz);
80107ea4:	8b 45 10             	mov    0x10(%ebp),%eax
80107ea7:	05 ff 0f 00 00       	add    $0xfff,%eax
80107eac:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107eb1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107eb4:	e9 8a 00 00 00       	jmp    80107f43 <deallocuvm+0xb5>
    pte = walkpgdir(pgdir, (char*)a, 0);
80107eb9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ebc:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107ec3:	00 
80107ec4:	89 44 24 04          	mov    %eax,0x4(%esp)
80107ec8:	8b 45 08             	mov    0x8(%ebp),%eax
80107ecb:	89 04 24             	mov    %eax,(%esp)
80107ece:	e8 9b f9 ff ff       	call   8010786e <walkpgdir>
80107ed3:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80107ed6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107eda:	75 16                	jne    80107ef2 <deallocuvm+0x64>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80107edc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107edf:	c1 e8 16             	shr    $0x16,%eax
80107ee2:	83 c0 01             	add    $0x1,%eax
80107ee5:	c1 e0 16             	shl    $0x16,%eax
80107ee8:	2d 00 10 00 00       	sub    $0x1000,%eax
80107eed:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107ef0:	eb 4a                	jmp    80107f3c <deallocuvm+0xae>
    else if((*pte & PTE_P) != 0){
80107ef2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ef5:	8b 00                	mov    (%eax),%eax
80107ef7:	83 e0 01             	and    $0x1,%eax
80107efa:	85 c0                	test   %eax,%eax
80107efc:	74 3e                	je     80107f3c <deallocuvm+0xae>
      pa = PTE_ADDR(*pte);
80107efe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107f01:	8b 00                	mov    (%eax),%eax
80107f03:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107f08:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80107f0b:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107f0f:	75 0c                	jne    80107f1d <deallocuvm+0x8f>
        panic("kfree");
80107f11:	c7 04 24 65 89 10 80 	movl   $0x80108965,(%esp)
80107f18:	e8 45 86 ff ff       	call   80100562 <panic>
      char *v = P2V(pa);
80107f1d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107f20:	05 00 00 00 80       	add    $0x80000000,%eax
80107f25:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80107f28:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107f2b:	89 04 24             	mov    %eax,(%esp)
80107f2e:	e8 e0 ab ff ff       	call   80102b13 <kfree>
      *pte = 0;
80107f33:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107f36:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
80107f3c:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107f43:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f46:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107f49:	0f 82 6a ff ff ff    	jb     80107eb9 <deallocuvm+0x2b>
    }
  }
  return newsz;
...
80107f57:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80107f5a:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107f5e:	75 0c                	jne    80107f6c <freevm+0x18>
    panic("freevm: no pgdir");
80107f60:	c7 04 24 6b 89 10 80 	movl   $0x8010896b,(%esp)
80107f67:	e8 f6 85 ff ff       	call   80100562 <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80107f6c:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107f73:	00 
80107f74:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80107f7b:	80 
80107f7c:	8b 45 08             	mov    0x8(%ebp),%eax
80107f7f:	89 04 24             	mov    %eax,(%esp)
80107f82:	e8 07 ff ff ff       	call   80107e8e <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80107f87:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107f8e:	eb 45                	jmp    80107fd5 <freevm+0x81>
    if(pgdir[i] & PTE_P){
...
80107fa6:	74 29                	je     80107fd1 <freevm+0x7d>
...
80107fbe:	05 00 00 00 80       	add    $0x80000000,%eax
80107fc3:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80107fc6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107fc9:	89 04 24             	mov    %eax,(%esp)
80107fcc:	e8 42 ab ff ff       	call   80102b13 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
80107fd1:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107fd5:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80107fdc:	76 b2                	jbe    80107f90 <freevm+0x3c>
    }
  }
  kfree((char*)pgdir);
80107fde:	8b 45 08             	mov    0x8(%ebp),%eax
80107fe1:	89 04 24             	mov    %eax,(%esp)
80107fe4:	e8 2a ab ff ff       	call   80102b13 <kfree>
}
80107fe9:	c9                   	leave  
80107fea:	c3                   	ret    
...
80107ff1:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107ff8:	00 
80107ff9:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ffc:	89 44 24 04          	mov    %eax,0x4(%esp)
80108000:	8b 45 08             	mov    0x8(%ebp),%eax
80108003:	89 04 24             	mov    %eax,(%esp)
80108006:	e8 63 f8 ff ff       	call   8010786e <walkpgdir>
8010800b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
8010800e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108012:	75 0c                	jne    80108020 <clearpteu+0x35>
    panic("clearpteu");
80108014:	c7 04 24 7c 89 10 80 	movl   $0x8010897c,(%esp)
8010801b:	e8 42 85 ff ff       	call   80100562 <panic>
  *pte &= ~PTE_U;
80108020:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108023:	8b 00                	mov    (%eax),%eax
80108025:	83 e0 fb             	and    $0xfffffffb,%eax
80108028:	89 c2                	mov    %eax,%edx
...
80108034:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108037:	e8 66 f9 ff ff       	call   801079a2 <setupkvm>
8010803c:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010803f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108043:	75 0a                	jne    8010804f <copyuvm+0x1e>
    return 0;
80108045:	b8 00 00 00 00       	mov    $0x0,%eax
8010804a:	e9 03 01 00 00       	jmp    80108152 <copyuvm+0x121>
  for(i = 0; i < sz; i += PGSIZE){
8010804f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108056:	e9 d6 00 00 00       	jmp    80108131 <copyuvm+0x100>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010805b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010805e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108065:	00 
80108066:	89 44 24 04          	mov    %eax,0x4(%esp)
8010806a:	8b 45 08             	mov    0x8(%ebp),%eax
8010806d:	89 04 24             	mov    %eax,(%esp)
80108070:	e8 f9 f7 ff ff       	call   8010786e <walkpgdir>
80108075:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108078:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010807c:	75 0c                	jne    8010808a <copyuvm+0x59>
      panic("copyuvm: pte should exist");
8010807e:	c7 04 24 86 89 10 80 	movl   $0x80108986,(%esp)
80108085:	e8 d8 84 ff ff       	call   80100562 <panic>
    if(!(*pte & PTE_P))
8010808a:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010808d:	8b 00                	mov    (%eax),%eax
8010808f:	83 e0 01             	and    $0x1,%eax
80108092:	85 c0                	test   %eax,%eax
80108094:	75 0c                	jne    801080a2 <copyuvm+0x71>
      panic("copyuvm: page not present");
80108096:	c7 04 24 a0 89 10 80 	movl   $0x801089a0,(%esp)
8010809d:	e8 c0 84 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
801080a2:	8b 45 ec             	mov    -0x14(%ebp),%eax
801080a5:	8b 00                	mov    (%eax),%eax
801080a7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801080ac:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
801080af:	8b 45 ec             	mov    -0x14(%ebp),%eax
801080b2:	8b 00                	mov    (%eax),%eax
801080b4:	25 ff 0f 00 00       	and    $0xfff,%eax
801080b9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801080bc:	e8 e8 aa ff ff       	call   80102ba9 <kalloc>
801080c1:	89 45 e0             	mov    %eax,-0x20(%ebp)
801080c4:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801080c8:	75 02                	jne    801080cc <copyuvm+0x9b>
      goto bad;
801080ca:	eb 76                	jmp    80108142 <copyuvm+0x111>
...
801080e0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801080e3:	89 04 24             	mov    %eax,(%esp)
801080e6:	e8 ee cf ff ff       	call   801050d9 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801080eb:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801080ee:	8b 45 e0             	mov    -0x20(%ebp),%eax
801080f1:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
801080f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080fa:	89 54 24 10          	mov    %edx,0x10(%esp)
801080fe:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
...
80108114:	e8 f1 f7 ff ff       	call   8010790a <mappages>
80108119:	85 c0                	test   %eax,%eax
8010811b:	79 0d                	jns    8010812a <copyuvm+0xf9>
      kfree(mem);
8010811d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108120:	89 04 24             	mov    %eax,(%esp)
80108123:	e8 eb a9 ff ff       	call   80102b13 <kfree>
      goto bad;
80108128:	eb 18                	jmp    80108142 <copyuvm+0x111>
  for(i = 0; i < sz; i += PGSIZE){
8010812a:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108131:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108134:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108137:	0f 82 1e ff ff ff    	jb     8010805b <copyuvm+0x2a>
    }
  }
  return d;
8010813d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108140:	eb 10                	jmp    80108152 <copyuvm+0x121>

bad:
  freevm(d);
80108142:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108145:	89 04 24             	mov    %eax,(%esp)
80108148:	e8 07 fe ff ff       	call   80107f54 <freevm>
  return 0;
8010814d:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108152:	c9                   	leave  
80108153:	c3                   	ret    
...
80108157:	83 ec 28             	sub    $0x28,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
8010815a:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108161:	00 
...
8010816f:	e8 fa f6 ff ff       	call   8010786e <walkpgdir>
...
801081b1:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
801081b7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801081ba:	e9 87 00 00 00       	jmp    80108246 <copyout+0x98>
    va0 = (uint)PGROUNDDOWN(va);
801081bf:	8b 45 0c             	mov    0xc(%ebp),%eax
801081c2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801081c7:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
801081d7:	e8 78 ff ff ff       	call   80108154 <uva2ka>
801081dc:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801081df:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801081e3:	75 07                	jne    801081ec <copyout+0x3e>
      return -1;
801081e5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801081ea:	eb 69                	jmp    80108255 <copyout+0xa7>
    n = PGSIZE - (va - va0);
801081ec:	8b 45 0c             	mov    0xc(%ebp),%eax
801081ef:	8b 55 ec             	mov    -0x14(%ebp),%edx
801081f2:	29 c2                	sub    %eax,%edx
801081f4:	89 d0                	mov    %edx,%eax
801081f6:	05 00 10 00 00       	add    $0x1000,%eax
801081fb:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801081fe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108201:	3b 45 14             	cmp    0x14(%ebp),%eax
80108204:	76 06                	jbe    8010820c <copyout+0x5e>
      n = len;
80108206:	8b 45 14             	mov    0x14(%ebp),%eax
...
80108214:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108217:	01 c2                	add    %eax,%edx
80108219:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010821c:	89 44 24 08          	mov    %eax,0x8(%esp)
80108220:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108223:	89 44 24 04          	mov    %eax,0x4(%esp)
80108227:	89 14 24             	mov    %edx,(%esp)
8010822a:	e8 aa ce ff ff       	call   801050d9 <memmove>
    len -= n;
8010822f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108232:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108235:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108238:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
8010823b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010823e:	05 00 10 00 00       	add    $0x1000,%eax
80108243:	89 45 0c             	mov    %eax,0xc(%ebp)
  while(len > 0){
80108246:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
8010824a:	0f 85 6f ff ff ff    	jne    801081bf <copyout+0x11>
  }
  return 0;
